...
fs.writeFileSync("temp_header_clean3.html", content);

// Run htmltojsx
execSync("npx htmltojsx temp_header_clean3.html > temp_header_clean3.jsx");

let jsx = fs.readFileSync("temp_header_clean3.jsx", "utf8");

// Replace headerTopSlider up to headerTopSocial cleanly
jsx = jsx.replace(
    /<div className="headerTopSlider position-relative">[\s\S]*?(?=<div className="headerTopSocial)/,
    "<HeaderSlider />\n      "
);
...
console.log("Header.tsx structure rebuilt 100% cleanly!");
