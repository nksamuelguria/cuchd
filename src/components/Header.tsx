        ...
        <div className="headerTopBar flex items-center justify-between">
                    ...
                    <div className="carousel-inner text-center">
                        ...
                        <div className="carousel-item active" data-bs-interval="3000">
                            Register Now for CU Joint Campus Placement Programme <a
                                ...
                                className="xs-btn text-white btn-hoverEffect">Register Now</a>
                        </div>
                        <div className="carousel-item" data-bs-interval="3000">Learn Beyond Classrooms, Get Certified, and
                            Discover Your Path Early <a href="https://www.cuchd.in/acp/" target="_blank"
                                className="xs-btn text-white">Register Now</a>
                        </div>
                        <div className="carousel-item" data-bs-interval="3000">International Moot Court Competition on Artificial Intelligence & Intellectual Property Rights <a href="https://www.cuchd.in/conference/imccai-26/"
                                target="_blank" className="xs-btn text-white">Register Now</a>
                        </div>
                         

                        <div className="carousel-item" data-bs-interval="3000">IC-AMDFA-2026 (Advanced Materials & Devices for Futuristic
                                                Applications- 2026 )<a
                                href="https://www.cuchd.in/conference/icamdfa-26/" target="_blank"
                                className="xs-btn text-white">Register
                                Now</a>
                        </div>
                    </div>
            ...
            <div className="headerTopSocial flex items-center">
                <ul className="header__top-right w-auto flex list-none p-0 m-0">
                    <li><a href="https://www.cuchd.in/whatsapp.php" target="_blank"
                            aria-label="Call on CU's Whatsapp"><i
                                className="fa-brands fa-whatsapp"></i><span>Whatsapp</span></a></li>
                    <li className="ph-missed"><a href="tel:8033094409" aria-label="Give a miss call"><i
                                className="fa-solid fa-phone" style={{ fontSize: `12px` }}></i><span>Call Us</span></a></li>
                    <li><a href="https://www.cuchd.in/maps/" id="vt-bt" aria-label="Get a Virtual Tour of CU campus"><i
                                className="fa-solid fa-compass" style={{ fontSize: `12px` }}></i><span>360<sup>o</sup></span></a>
                    </li>
                </ul>
                <ul className="header__top-right social-sub w-auto flex list-none p-0 m-0 items-center">
                    ...
                    <li><a rel="nofollow" href="https://www.threads.net/@chandigarhuniversity" target="_blank"
                            ...
                            <i className="fa-brands fa-threads"></i></a></li>
                    <li><a rel="nofollow" href="https://www.snapchat.com/add/chd_university" target="_blank"
                            aria-label="Go to Chandigarh University's Snapchat">
                            <i className="fa-brands fa-snapchat"></i></a></li>
                </ul>
                <ul className="header__top-right w-auto flex list-none p-0 m-0 items-center desksearch">
                    <li className="head-search m-0">
                        <button id="search-page-mob" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            aria-label="Search Chandigarh University Website" className="text-white m-0">
        ...
        <div className="navbar-brand p-0 mt-0">
            <div className="flex items-center">
                ...
                <a href="https://www.cuchd.in/" aria-label="Go to Chandigarh University's Home Page" className="dark-logo">
                    <img src="/header-footer/cu-logo-dark-new.webp" alt="" width="221"
                        className="mr-2 cu-logo" />
                </a>
            </div>
            <div className="flex ml-auto showOnMobile">
                <div className="flex header_btn blue-gradient mr-3">
                    <a href="tel:+1800121288800" className="flex items-center text-white"
                        aria-label="Call CU's Admission Helpline">
                ...
                <ul className="header__top-right w-auto flex list-none p-0 m-0 items-center tabletsearch">
                    <li className="head-search m-0">
                        <button id="search-page-mob" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            aria-label="Search Chandigarh University Website" className="text-white m-0"><i
                                className="fa fa-search" aria-hidden="true"></i><span>Search</span></button>
                    </li>
                </ul>
                    <button className="navbar-toggler px-3 py-1 border border-transparent rounded bg-transparent flex xl:hidden" type="button" data-bs-toggle="hidden"
                        data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent"
                        aria-expanded="false" aria-label="Toggle navigation" title="View Institutes">
                        <span className="navbar-toggler-icon inline-block w-[1.5em] h-[1.5em] bg-center bg-no-repeat bg-contain"></span>
                    </button>                     
            </div>
        </div>
        <nav className="navbar navbar-expand-xl flex flex-wrap items-center justify-between py-2 px-4 xl:flex-nowrap xl:justify-start z-50 w-full" data-lenis-prevent-wheel>

            <div className="mobileNavHeader hidden">
                <a href="https://www.cuchd.in/" aria-label="Go to Chandigarh University's Home Page">
                    <img src="/header-footer/cu-logo-dark-new.webp" alt="" width="180"
                        className="mr-2 cu-logo" />
                </a>
            ...
            <div className="w-full px-4 items-start flex flex-wrap justify-between">
                <button id="main-toggler" className="navbar-toggler xl:hidden px-3 py-1 border border-transparent rounded bg-transparent" type="button">
                    <span className="navbar-toggler-icon inline-block w-[1.5em] h-[1.5em] bg-center bg-no-repeat bg-contain"></span>
                </button>
                <div className="hidden w-full flex-grow basis-full items-center xl:flex xl:w-auto xl:basis-auto" id="navbarCollapse">
                    <div className="upper-header">
                        <ul className="menu-options list-none m-0 p-0 m-auto"> 
                            
                            <li className="nav-item relative campusDdLink">
                                <a href="#">Campuses</a>
                                <div className="campusDd">
                                    <div className="flex flex-wrap -mx-4 m-0 p-0">
                                        <div className="w-1/2 px-4">
                                            <a href="https://www.cuchd.in/">
                                                <img src="/header-footer/cuchd-icon.webp" alt=""
                                                    className="w-full" width="70" />
                                                <span>Punjab <br />Campus</span>
                                            </a>
                                        </div>
                                        <div className="w-1/2 px-4">
                                            <a rel="" href="https://www.culko.in/" target="_blank">
                                                <img src="/header-footer/culko-icon.webp" alt=""
                                                    className="w-full" width="70" />
                    ...
                    <div className="lower-header">
                        <ul className="navbar-nav flex-col xl:flex-row w-full mr-auto step-first-menu flex justify-around">
                            <li className="nav-item relative dd-menu-lg relative">
                                ...
                                <div className="step-second-menu st-about">
                                    <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                        <div className="sm:w-1/2 px-4 xl:w-1/3 px-4">
                                            <h4>Who We Are</h4>
                                        ...
                                        <div className="md:w-1/3 px-4 about-graphic hidden lg:block lazy-bg"
                                            style={{ background: `url('/header-footer/lazy-about-dd-image.webp')`, margin: `-20px -20px -20px 20px`, backgroundSize: `cover` }}
                                            data-bg="/header-footer/about-dd-image.webp">
                                                ...
                                                <div className="dd-graphic-cont absolute bottom-0">
                                                    <div className="flex flex-wrap -mx-4 m-0 p-0">
                                                        <div className="w-1/2 px-4 p-2 py-3 flex">
                                                            <div className="dd--title self-center mx-auto">
                                                                <span>
                                                            ...
                                                            <div className="dd--title self-center mx-auto">
                                                                <span>
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        <circle className="stval" cx="342" cy="276"
                                                                            r="10" />
                                                                        <path className="stval"
                            ...
                            <li className="nav-item relative dd-menu-lg relative">
                                ...
                                <div className="step-second-menu st-programs">
                                    <div className="flex flex-wrap -mx-4 h-full m-0 p-0">
                                        <div className="xl:w-10/12 px-4 lg:w-full px-4">
                                            <div className="menuTabs">
                                                <ul className="nav nav-tabs">
                                                    <li className="nav-item relative">
                                                        <a className="block px-4 py-2 active block px-4 py-2" href="#">
                                                            <strong>Regular <i
                                                                    className="fas fa-arrow-circle-down ml-1"></i></strong>
                                                        </a>
                                                    </li>
                                            ...
                                            <div className="flex flex-wrap -mx-4">
                                                <div className="md:w-1/2 px-4 xl:w-5/12 px-4">
                                                    <div className="flex flex-wrap -mx-4">
                                                        <div className="xl:w-1/2 px-4">
                                                            <ul className="list-none p-0 m-0">
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        &amp; Humanities <small
                                                                            style={{ fontSize: `11px` }}>(B.A &
                                                                            M.A)</small></a>
                                                                </li>
                                                                
                                                                <li><a href="https://www.cuchd.in/basic-sciences/">Physics<small
                                                                            style={{ fontSize: `11px` }}> (B.Sc./ M.Sc.)</small></a>
                                                                </li>
                                                                  <li><a href="https://www.cuchd.in/basic-sciences/">Chemistry<small
                                                                            style={{ fontSize: `11px` }}> (B.Sc./ M.Sc.)</small></a>
                                                                </li>
																  <li><a href="https://www.cuchd.in/basic-sciences/">Mathematics<small
                                                                            style={{ fontSize: `11px` }}> (B.Sc./ M.Sc.)</small></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div className="xl:w-1/2 px-4">
                                                            <ul className="list-none p-0 m-0">
                                                                ...
                                                                <li><a href="https://www.cuchd.in/basic-sciences/">Mathematics
                                                                        <small
                                                                            style={{ fontSize: `11px` }}>(B.Sc./M.Sc./Phd)</small></a>
                                                                </li>
                                                            ...
                                                            <ul className="list-none p-0 m-0">
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        Data Science with <img
                                                                            src="/header-footer/intel-logo.svg"
                                                                            alt="MCA Data Science with Intel"
                                                                            style={{ marginTop: `-2px` }} width="26px"
                                                                            className="ptrans lazy-img" /></a>
                                                                </li>
                                                                <li><a href="https://www.cuchd.in/IBM/">CSE with <img
                                                                            src="/header-footer/IBM-logo.webp"
                                                                            alt="MBA with IBM" style={{ marginTop: `-3px` }}
                                                                            width="30px" className="ptrans lazy-img" /></a>
                                                                </li>
                                                                <li><a
                                                                        href="https://www.cuchd.in/engineering/be-cse-artificial-intelligence.php">BE
                                                                        CSE Artificial<br /> Intelligence with <img
                                                                            src="/header-footer/microsoft-logo.png"
                                                                            alt="BE CSE AI with Microsoft"
                                                                            style={{ verticalAlign: `baseline`, marginLeft: `2px` }}
                                                                            width="60px" className="ptrans lazy-img" /></a>
                                                                </li>
                                                                <li><a
                                                                        href="https://www.cuchd.in/engineering/virtusa-me-cse-cloud-computing.php">ME
                                                                        CSE Cloud<br /> Computing with <img
                                                                            src="/header-footer/virtusa-logo.webp"
                                                                            alt="ME CSE with Virtusa"
                                                                            style={{ marginTop: `-4px` }} width="50px"
                                                                            className="ptrans lazy-img" /></a>
                                                                </li>
                                                                <li><a href="https://www.cuchd.in/TCS/">CSE with <img
                                                                            src="/header-footer/TCS-logo.webp"
                                                                            alt="MBA with TCS" style={{ marginTop: `-1px` }}
                                                                            width="130px" className="ptrans lazy-img" /></a>
                                                                </li>
                                                                <li><a
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        Healthcare and Hospital Management <img
                                                                            src="/header-footer/max-logo.jpg"
                                                                            alt="MBA
                                                                        Healthcare and Hospital Management"
                                                                            width="75px" className="lazy-img" /></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="md:w-full px-4 xl:w-1/6 px-4">
                                                    <ul className="list-none p-0 m-0">
                                                        <li><a
                                                                ...
                                                                in Capital Markets with <img
                                                                    src="/header-footer/nism-logo.webp"
                                                                    alt="MBA in Capital Markets with NISM" width=""
                                                                    className="ptrans lazy-img" /></a>
                                                        </li>
                                                        <li><a
                                                                href="https://www.cuchd.in/apex-management/mba-strategic-hr.php">MBA
                                                                Strategic HR with <img
                                                                    src="/header-footer/aon-logo.webp"
                                                        ...
                                                        <li><a
                                                                ...
                                                                Data Science & AI with <img
                                                                    src="/header-footer/sas-logo.webp"
                                                                    alt="MBA with SAS" style={{ marginTop: `-3px` }}
                                                                    width="30px" className="ptrans lazy-img" /></a>
                                                        </li>
                                                        <li><a
                                                        ...
                                                        <li><a
                                                                ...
                                                                in Applied Finance & Analytics with <img
                                                                    src="/header-footer/pwc-logo-new.png"
                                                                    alt="MBA with pwc" style={{ marginTop: `-8px` }}
                                                                    width="30px" className="ptrans lazy-img" /></a>
                                                        </li>

                                                        <li><a href="https://www.cuchd.in/apex-management/bfe.php">MBA
                                                                in Banking, Financial Services & Insurance <img
                                                                    src="/header-footer/SBI-logo.webp"
                                                                    alt="MBA Banking and Financial Engineering with SBI"
                                                                    style={{ marginTop: `-3px` }} width="90px"
                                                                    className="ptrans lazy-img" /></a>
                                                        </li>
                                                        ...
                                                        <li><a
                                                                ...
                                                                FinTech & AI <img
                                                                    src="/header-footer/nse-acadmey.webp"
                                                                    alt="MBA with Fintech" style={{ marginTop: `-2px` }}
                                                                    width="36px" className="ptrans lazy-img" /></a>
                                                        </li>
                                                        <li><a
                                                                href="https://www.cuchd.in/apex-management/MBA-logistics-and-supply-chain-management.php">MBA
                                                                Logistics and Supply Chain Management
                                                                with
                                                                <img src="/header-footer/cii-logo.webp"
                                                                    alt="MBA Logistics and Supply Chain Management with CII"
                                                                    style={{ marginTop: `0px` }} width="60px"
                                                                    className="ptrans lazy-img" /></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div className="flex flex-wrap -mx-4 g-3">
                                                ...
                                                <div className="md:w-full px-4 block lg:hidden mt-3">
                                                    <div className="flex flex-wrap -mx-4 g-3">
                                                        <div className="lg:w-1/2 px-4">
                                                            <div className="card br-6 p-3">
                                                                <a rel="nofollow"
                                                                    href="https://www.cuidol.in/?utm_source=Website&utm_medium=cuchd"
                                                                    target="_blank"
                                                                    className="relative text-black uppercase"><small>Click
                                                                        here to view Programs
                                                                        of</small><br /> <b> Open &amp; Distance Learning
                                                                        (ODL)<small><i
                                                                                className="fas fa-external-link-alt ml-1"></i></small></b></a>
                                                            </div>
                                                        </div>
                                                        <div className="lg:w-1/2 px-4">
                                                            <div className="card br-6 p-3">
                                                                <a rel="nofollow"
                                                                    href="https://www.onlinecu.in/?utm_source=Website&utm_medium=cuchd"
                                                                    target="_blank"
                                                                    className="relative text-black uppercase"><small>Click
                                                                        here to view Programs
                                        ...
                                        <div className="xl:w-1/6 px-4 lg:w-full px-4 pg-bg program-graphic hidden lg:block lazy-bg"
                                            style={{ background: `url('/header-footer/lazy-program-dd-image.webp')`, margin: `-20px -20px -20px 20px`, backgroundSize: `cover` }}
                                            data-bg="/header-footer/program-dd-image.webp">
                                            <div className="program-drop-down-graphic relative h-full">
                                                ...
                                                <div className="placement--ddNumbers progNos mt-3">
                                                    <div className="flex flex-wrap -mx-4 -mx-2">
                                                        <div className="w-1/3 px-4 xl:w-full px-4">
                                                            <div className="card p-2">
                                                                <span>
                                                                    <h4 id="plac-no"><span
                                                                            className="hidden"></span>10000+
                                                                    </h4>
                            ...
                            <li className="nav-item relative dd-menu-lg relative">
                                ...
                                <div className="step-second-menu st-academics">
                                    <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                        ...
                                        <div className="lg:w-7/12 px-4 hidden xl:block lazy-bg"
                                            style={{ background: `url('/header-footer/lazy-about-dd-image.webp')`, margin: `-20px -20px -20px 20px`, backgroundSize: `cover` }}
                                            data-bg="/header-footer/about-dd-image.webp">
                                            <div className="drop-down-graphic relative h-full">
                                                            ...
                                                            <div className="dd--title self-center mx-auto">
                                                                <span>
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        `}</style>
                                                                        <rect x="373.3" y="373.3" className="stval"
                                                                            width="42.7" height="21.3" />
                                                                        <rect x="373.3" y="245.3" className="stval"
                                                                            width="42.7" height="21.3" />
                                                                        <rect x="85.3" y="64" className="stval"
                                                                            width="106.7" height="21.3" />
                                                                        <rect x="85.3" y="106.7" className="stval"
                                                                            width="21.3" height="21.3" />
                                                                        <rect x="128" y="106.7" className="stval"
                                                                            width="21.3" height="21.3" />
                                                                        <path className="stval"
                                                                        ...
                                                                        <rect x="288" y="426.7" className="stval"
                                                                            width="42.7" height="21.3" />
                                                                        <path className="stval"
                                                                        ...
                                                                        <rect x="373.3" y="309.3" className="stval"
                                                                            width="64" height="21.3" />
                                                                        <rect x="373.3" y="181.3" className="stval"
                                                                            width="64" height="21.3" />
                                                                        <rect x="373.3" y="437.3" className="stval"
                                                                            width="64" height="21.3" />
                                                                        <path className="stval"
                                                                        ...
                                                                        <rect x="202.7" y="170.7" className="stval"
                                                                            width="42.7" height="21.3" />
                                                                        <rect x="202.7" y="213.3" className="stval"
                                                                            width="53.3" height="21.3" />
                                                                        <rect x="202.7" y="277.3" className="stval"
                                                                            width="42.7" height="21.3" />
                                                                        <rect x="202.7" y="320" className="stval"
                                                                            width="53.3" height="21.3" />
                                                                        <rect x="202.7" y="384" className="stval"
                                                                            width="42.7" height="21.3" />
                                                                        <rect x="202.7" y="426.7" className="stval"
                                                                            width="53.3" height="21.3" />
                                                                    </svg>
                                                                </span>
                                                                70+ <br />Electives
                                                            ...
                                                            <div className="dd--title self-center mx-auto">
                                                                <span>
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        `}</style>
                                                                        <rect x="117.3" y="437.3" className="stval"
                                                                        ...
                                                                        <rect x="117.3" y="373.3" className="stval"
                                                                            width="53.3" height="21.3" />
                                                                        <rect x="341.3" y="373.3" className="stval"
                                                                            width="53.3" height="21.3" />
                                                                        <polygon className="stval"
                                                                        ...
                                                                        <rect x="325.3" y="159.6"
                                                                            ...
                                                                            className="stval" width="21.3" height="75.4" />
                                                                        <path className="stval"
                                                                            d="M408.5 163.1l-53.3 53.3c-2 2-3.1 4.7-3.1 7.5v64h21.3v-59.6l50.2-50.2L408.5 163.1z" />
                                                                        <rect x="245.3" y="181.3" className="stval"
                                                                            width="21.3" height="85.3" />
                                                                        <rect x="213.3" y="213.3" className="stval"
                            ...
                            <li className="nav-item relative dd-menu-lg relative">
                                ...
                                <div className="step-second-menu st-admissions">
                                    <div className="flex flex-wrap -mx-4">
                                        ...
                                        <div className="sm:w-1/2 px-4 xl:w-2/3 px-4">
                                            <h4>Admission</h4>
                                            <div className="flex flex-wrap -mx-4">
                                                <div className="xl:w-1/2 px-4">
                                                    <ul className="list-none p-0 m-0">
                                    ...
                                    <div className="hidden xl:block" style={{ margin: `65px -20px 0 -20px` }}>
                                        <div className="redbox-applynow relative seagreen-overlay-faded lazy-bg"
                                            style={{ backgroundImage: `url(/header-footer/lazy-unique3-bg.webp)` }}
                                            data-bg="/header-footer/unique3-bg.webp">
                                            <div className="relative">
                                                <h3>Unlock your Career Goals</h3>
                                                <div className="flex flex-wrap -mx-4 m-0 p-0">
                                                    <div className="w-1/3 px-4 p-2 py-3 flex">
                                                        <div className="dd--title self-center mx-auto">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li className="nav-item relative dd-menu-lg relative">
                                ...
                                <div className="step-second-menu st-campus">
                                    <div className="hidden xl:block" style={{ margin: `-20px -20px 15px -20px` }}>
                                        <div className="redbox-applynow relative seagreen-overlay-faded lazy-bg"
                                            style={{ backgroundImage: `url(/header-footer/lazy-campus-bg.webp)` }}
                                            data-bg="/header-footer/campus-bg.webp">
                                            <div className="relative">
                                                <h3>A Home away from Home</h3>
                                                <div className="flex flex-wrap -mx-4 m-0 p-0">
                                                    <div className="w-1/4 px-4 p-2 py-3 flex">
                                                        <div className="dd--title self-center mx-auto">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 480 480" width="44">
                                            ...
                                            <div className="flex flex-wrap -mx-4">
                                                <div className="md:w-full px-4">
                                                    <ul className="list-none p-0 m-0">
                                                        ...
                                                        <li><a href="https://www.cuchd.in/aifest-2026/"
                                                                target="_blank">AI Fest 2026</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="flex flex-wrap -mx-4">
                                                <div className="md:w-full px-4">
                                                    <ul className="list-none p-0 m-0">
                                                        ...
                                                        <li><a href="https://www.cuchd.in/campus-life/clubs-and-student-chapters.php"
                                                                rel="nofollow">Clubs, Communities, Department Societies
                                                                &amp; Student Chapters
                                                            </a>
                                                        </li>
                                                    </ul>
                            ...
                            <li className="nav-item relative dd-menu-lg relative">
                                ...
                                <div className="step-second-menu st-placements">
                                    <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                        <div className="lg:w-1/2 px-4 hidden xl:block lazy-bg"
                                            style={{ background: `url('/header-footer/lazy-placement-bg.webp')`, margin: `-20px 20px -20px -20px`, backgroundSize: `cover` }}
                                            data-bg="/header-footer/placement-bg.webp">
                                            <div className="drop-down-graphic relative h-full">
                                                ...
                                                <div className="dd-graphic-cont absolute bottom-0 w-full">
                                                    <div className="flex flex-wrap -mx-4 m-0 p-0">
                                                        ...
                                                        <div className="w-1/2 px-4 p-2 py-3 flex">
                                                            <div className="dd--title self-center mx-auto">
                                                                <span>
                                                                    <img className="w-full lazy-img"
                                                                        src="/header-footer/mahindra-logo-dark.webp" />
                                                                </span>
                                                                Mahindra
                                                            </div>
                                                        </div>
                            ...
                            <li className="nav-item relative dd-menu-lg relative">
                                ...
                                <div className="step-second-menu st-research">
                                    <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                        <div className="lg:w-1/2 px-4 hidden xl:block lazy-bg"
                                            style={{ background: `url('/header-footer/lazy-research-bg.webp')`, margin: `-20px 20px -20px -20px`, backgroundSize: `cover` }}
                                            data-bg="/header-footer/research-bg.webp">
                                            <div
                                                className="program-drop-down-graphic relative h-full text-center flex-col justify-between">
                                        ...
                                        <div className="lg:w-1/2 px-4">
                                            ...
                                            <h4 className="lg:mt-4">Entrepreneurship Cells</h4>
                                            <div className="flex flex-wrap -mx-4">
                                                <div className="md:w-full px-4">
                                                    <ul className="list-none p-0 m-0">
                                            ...
                                            <h4 className="lg:mt-4">Sustainable Development Goals (SDG's)</h4>
                                            <div className="flex flex-wrap -mx-4">
                                                <div className="md:w-full px-4">
                                                    <ul className="list-none p-0 m-0">
...
<a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&amp;utm_medium=engineering" className="inline-block px-4 py-2 rounded text-center cursor-pointer bg-[#fa0d0d] text-white hover:bg-[#d00b0b] border-none btn-hoverEffect apnowbtn " target="_blank">Apply Now <img alt="Button Arrow" width="13" className="ml-2" src="/header-footer/right-arrow-small.png" /></a>  
                            ...
                            <ul className="list-none step-first-menu hover-header-list ps-0">
                                <li className="active">
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/engg-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/engg-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                                    ...
                                                    <div className="btn-grp">
                                                        <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
                                                            className="inline-block px-4 py-2 rounded text-center cursor-pointer bg-[#fa0d0d] text-white hover:bg-[#d00b0b] border-none " target="_blank">Apply Today</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/management-institute-bg.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/management-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/computing-institute-bg.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/computing-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/pharma-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/pharma-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/bio-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/bio-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/arch-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/arch-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/liberal-institute-bg.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/liberal-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/uifva-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/uifva-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/uittr-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/uittr-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/legal-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/legal-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/media-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/media-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/uis-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/uis-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/ahs-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/ahs-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/design-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/design-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/uithm-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/uithm-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/gsfa-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/gsfa-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/cassm-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/cassm-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
                                ...
                                <li>
                                    ...
                                    <div className="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div className="flex flex-wrap -mx-4 m-0 p-0 h-full">
                                            <div className="lg:w-full px-4 h-55 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-big.webp')` }}
                                                data-bg="/header-footer/pes-institute-bg.webp"></div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block lazy-bg"
                                                style={{ background: `url('/header-footer/institute-bg-small.webp')` }}
                                                data-bg="/header-footer/pes-institute-bg-small.webp">
                                            </div>
                                            <div className="lg:w-1/2 px-4 h-45 hidden lg:block">
                                                <div
                                                    className="institute-content flex-col justify-between h-full p-4 p-xxl-5">
