export default function Footer() {
        ...
        <div className="flex flex-wrap -mx-4 g-4">
          ...
          <div className="w-1/2 px-4 col-sm-4 col-lg-2">
            ...
            <ul className="m-0 list-none">
              ...
              <li><a href="https://www.cuchd.in/dsaa/students-welfare.php#conduct" target="_blank">Discipline &amp; Student Conduct</a></li>
              <li><a href="https://www.onlinecu.in/" target="_blank" rel="nofollow">For CU Online Programmes</a></li>
    ...
    <div className="copyrights">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full px-4 w-full lg:w-1/4 px-4 col-md-5 social-media-icons ml-auto">
            <ul className="m-0 list-none flex justify-between">
              <li><a href="https://www.facebook.com/chandigarhuniversitygharuan" rel="nofollow" target="_blank" aria-label="Go to Chandigarh University's Facebook Page"><i className="fab fa-facebook" aria-hidden="true" /></a></li>
              <li><a href="https://twitter.com/Chandigarh_uni" rel="nofollow" target="_blank" aria-label="Go to Chandigarh University's Twitter (X) Page"><img src="../includes/assets/images/header-footer/twitter-icon.webp" alt="" height={12} className="f-twitter-icon" /></a></li>
              <li><a href="http://www.pinterest.com/chandigarhunive/boards/" rel="nofollow" target="_blank" aria-label="Go to Chandigarh University's Pinterest Page"><i className="fab fa-pinterest" aria-hidden="true" /></a></li>
              <li><a href="http://www.instagram.com/chandigarhuniversity/" rel="nofollow" target="_blank" aria-label="Go to Chandigarh University's Instagram Page"><i className="fab fa-instagram" aria-hidden="true" /></a></li>
              <li><a href="https://www.linkedin.com/school/chandigarh-university/" rel="nofollow" target="_blank" aria-label="Go to Chandigarh University's Linkedin Page"><i className="fab fa-linkedin" aria-hidden="true" /></a></li>
              <li><a href="https://www.youtube.com/user/chandigarhuniversity" rel="nofollow" target="_blank" aria-label="Go to Chandigarh University's Youtube Page"><i className="fab fa-youtube" aria-hidden="true" /></a></li>
              ...
              <li><a href="https://www.snapchat.com/add/chd_university" target="_blank" aria-label="Go to Chandigarh University's Snapchat Page"><i className="fa-brands fa-snapchat" /></a></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div className="allNotification">
    <button type="button" className="allNotification__icon" aria-label="Chandigarh University Notifications"><i className="fa-solid fa-bell bell" /></button>
    <div className="allNotification__list show"> {/* removed 'show' */}
      <ul className="list-none p-0 m-0">
        <li className="shadow">
          <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" target="_blank">
            <h6>CUCET 2026</h6>
            <p>G�200 Crore in Scholarships Await!</p>
            <span className="inline-block px-4 py-2 rounded text-center btn-md text-link">Apply Now !</span>
          </a>
        </li>
        {/* <li className="shadow">
          <a href="https://www.cuchd.in/innovfest-2026/" target="_blank">
              <h6>CU InnovFest 2026</h6>
              <p>Get Ready to Be Part of the Revolution!</p>
              <span className="inline-block px-4 py-2 rounded text-center btn-md text-link">Register Now !</span>
          </a>
      </li> */}
      </ul>
    </div>
  ...
  {/* Search Modal */}
  <div className="modal fade searchModal" id="exampleModal" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div className="modal-content bg-transparent border-0">
        ...
        <div className="modal-body pt-2 text-center uniSearch">
          <form className="relative" action="https://www.cuchd.in/searchresult.php" method="get" role="search">
            <input type="text" className="searchbar-input form-control" placeholder="Enter your keyword here" name="q" /> 
            <input type="submit" className="se-btn ptrans" style={{backgroundImage: 'url(../includes/assets/images/search-icon.webp)'}} />
          </form>       
        </div>
      </div>
    </div>
  </div>
  <div className="blur-lay" />
  <div className="footer-fixed-bar">
    <button type="button" className="page-scroll" aria-label="Chandigarh University Homepage">APPLY NOW  for CUCET - 2026 {/*(Registration End Date (Phase - 2): 10<sup>th</sup> October 2025)*/}</button>
  </div>
  <div className="gotoTop">
    <button type="button" className="gotoTop__icon"><i className="fa fa-arrow-circle-up" aria-hidden="true" /></button>
  </div>
  {/* javascripts files */}
