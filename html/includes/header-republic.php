...
$patents = '4300+';
$startups = '150';
$publishedJournals = '14700+';
$waltDisney = '370+';
$researchCenter = '60';
?>

<!-- REPUBLIC DAY COLOR SCHEME 2025 E10303 -->
<style>
.header.sticky, .placement--ddNumbers .card {
	background: #db4307!important;
}    
.header_btn, #navbarToggleExternalContent .mega-menu, .tpNumbersCard__title {
	background: #f04e0e;
}
...
.institute-list {
	scrollbar-color: #f0f0f0 #2023d1;
}    
.xs-btn {
	background: #d7867e;
}  
.program-drop-down-graphic h3 span, .drop-down-graphic h3 span {
	color: #f9a335;
}    
.seagreen-overlay-faded::before, .cuFeatures-section .card::after, .dd-graphic-cont {
	background: rgba(138, 47, 11, 0.8);
}  
.btn-primary {
	background-color: #2023d1;
}
.btn-secondary {
	background-color: #2023d1;
	color: #fff !important;
}
.topHighlights-section, .uniPlacement-section, .cuResearch-section {
	background: #2023d1;
}
.researchLabs-slider .card-footer.opened {
	background: rgba(11, 43, 138, 0.8) !important;
}
.footer-fixed-bar {
	background: #1ac234;
}  
...
<header class="header fixed-top">
    <div class="header__main">
        <div class="headerTopBar d-flex align-items-center justify-content-between">
            <div class="headerTopSlider customControl slArrow slArrow-sm position-relative">
                <div class="whatsNew-slider">
                    <div class="whatsNew-slider__item">
                        Register Now for CU Joint Campus Placement Programme <a
                            ...
                            class="xs-btn">Register Now</a>
                    </div>
                    <div class="whatsNew-slider__item">International Conference on Innovative Trends in Electrical,
                        Electronics and Bio-Technology Engineering <a
                            href="https://www.cuchd.in/conference/iciteeb-2025/" target="_blank" class="xs-btn">Register
                            Now</a>
                    </div>
                    <div class="whatsNew-slider__item">1st International Conference on Building Urban Infrastructure with Leading Design Innovations (BUILD- 2025) <a
                            href="https://www.cuchd.in/conference/build-2025/" target="_blank" class="xs-btn">Register
                            Now</a>
                    </div>
                    <div class="whatsNew-slider__item">2nd International Conference on "Innovation and Regenerative Trends in Tourism and Hospitality Industry" <a
                            href="https://www.cuchd.in/conference/srishti-irtthi/" target="_blank" class="xs-btn">Register
                            Now</a>
                    </div>
                </div>
            </div>
            <div class="headerTopSocial d-flex align-items-center">
                ...
                <ul class="header__top-right social-sub w-auto d-flex list-unstyled p-0 m-0 align-items-center">
                    <li><a href="https://www.facebook.com/chandigarhuniversitygharuan" target="_blank"
                            aria-label="Go to Chandigarh University's Facebook Page"><i
                                class="fa-brands fa-facebook-f"></i></a></li>

                    <li><a href="https://www.twitter.com/chandigarh_uni" target="_blank"
                            aria-label="Go to Chandigarh University's Twitter (X) Page">
                            <i class="fa-brands fa-x-twitter"></i></a></li>

                    <li><a href="https://www.linkedin.com/school/chandigarh-university/" target="_blank"
                            aria-label="Go to Chandigarh University's Linkedin Page"><i
                                class="fa-brands fa-linkedin-in"></i></a></li>

                    <li><a href="https://www.instagram.com/chandigarhuniversity" target="_blank"
                            aria-label="Go to Chandigarh University's Instagram Page"><i
                                class="fa-brands fa-instagram"></i></a></li>

                    <li><a href="https://www.youtube.com/user/chandigarhuniversity" target="_blank"
                            aria-label="Go to Chandigarh University's Youtube Page"><i
                                class="fa-brands fa-youtube"></i></a></li>

                    <li><a href="https://www.threads.net/@chandigarhuniversity" target="_blank"
        ...
        <div class="navbar-brand p-0 mt-0">
            <div class="d-flex align-items-center">
                <a href="https://www.cuchd.in/" aria-label="Go to Chandigarh University's Home Page">
                    <img src="<?= @$imgPath ?>header-footer/animated-rep-logo.webp" alt="" width="210" class="me-2 cu-logo"> <!-- Replace with 'cu-logo-rep.webp' -->
                </a>
            </div>
        ...
        <nav class="navbar navbar-expand-xl">
            ...
            <div class="mobileNavHeader d-none">
                <a href="https://www.cuchd.in/" aria-label="Go to Chandigarh University's Home Page">
                    <img src="<?= @$imgPath ?>header-footer/cu-logo-dark.webp" alt="" width="180" class="me-2 cu-logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="upper-header">
                        <ul class="menu-options position-relative list-unstyled m-0 p-0 m-auto">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-6">
                                            <a href="https://www.cuchd.in/">
                                                <img src="<?= @$imgPath ?>header-footer/cuchd-icon.webp" alt=""
                                                    class="w-100" width="70">
                                                <span>Punjab <br>Campus</span>
                                            </a>
                                        </div>
                                        <div class="col-6">
                                            <a href="http://www.culko.in/" target="_blank">
                                                <img src="<?= @$imgPath ?>header-footer/culko-icon.webp" alt=""
                                                    class="w-100" width="70">
                            ...
                            <li><a href="<?= @$rootPath ?>international/index.php">International</a></li>
                        ...
                        <ul class="navbar-nav me-auto step-first-menu d-flex justify-content-around">
                                    ...
                                    <div class="row g-0 h-100">
                                        <div class="col-xl-4">
                                            ...
                                            <ul class="list-unstyled p-0 m-0">
                                                ...
                                                <li><a href="<?= @$rootPath ?>about/our-identity.php">Our Identity</a>
                                                </li>
                                                ...
                                                <li><a
                                                        href="<?= @$rootPath ?>about/institution-social-responsibility.php">Institutional
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <ul class="list-unstyled p-0 m-0">
                                                ...
                                                <li><a href="<?= @$rootPath ?>student-services/">Student Services</a>
                                                </li>
                                        ...
                                        <div class="col-md-4 about-graphic d-none d-lg-block lazy-bg"
                                            style="background: url('<?= @$imgPath ?>header-footer/lazy-about-dd-image.webp'); margin: -20px -20px -20px 20px;  background-size: cover;"
                                            data-bg="<?= @$imgPath ?>header-footer/about-dd-image.webp">
                                ...
                                <div class="step-second-menu st-programs">
                                    <div class="row h-100 g-0">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                <li><a
                                                                        href="<?= @$rootPath ?>engineering/">Engineering</a>
                                                                </li>
                                                                <li><a href="<?= @$rootPath ?>management/">Management
                                                                        (BBA/MBA)</a>
                                                                </li>
                                                                <li><a href="<?= @$rootPath ?>apex-management/">Management-Apex
                                                                    </a>
                                                                </li>
                                                                <li><a href="<?= @$rootPath ?>computing/">Computing
                                                                        (BCA/
                                                                        MCA)</a>
                                                                </li>
                                                                <li><a
                                                                ...
                                                                <li><a
                                                                        href="<?= @$rootPath ?>animation-and-multimedia/">Animation
                                                                        &amp; Multimedia</a>
                                                                </li>
                                                                ...
                                                                <li><a
                                                                        href="<?= @$rootPath ?>liberal-arts-and-humanities/">Arts
                                                                        &amp; Humanities</a>
                                                                </li>
                                                                ...
                                                                <li><a href="<?= @$rootPath ?>biotechnology/">Biotechnology
                                                                        &amp; Biosciences</a>
                                                                </li>
                                                                <li><a
                                                        ...
                                                        <div class="col-xl-6">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                <li><a href="<?= @$rootPath ?>basic-sciences/">Chemistry/
                                                                        Physics/ Mathematics</a>
                                                                </li>
                                                                <li><a href="<?= @$rootPath ?>commerce/">Commerce
                                                                        (B.Com)</a>
                                                                </li>
                                                                <li><a
                                                                ...
                                                                <li><a href="<?= @$rootPath ?>economics/">Economics</a>
                                                                </li>
                                                                <li><a
                                                                        href="<?= @$rootPath ?>teachers-training-and-research/">Education
                                                                        (B.A.B.Ed/ B.Sc.B.Ed)</a>
                                                                </li>
                                                                <li><a
                                                                        href="<?= @$rootPath ?>design/bachelor-of-design-fashion.php">Fashion
                                                                        &amp; Design</a>
                                                                </li>
                                                                <li><a href="<?= @$rootPath ?>design/fine-arts.php">Fine
                                                                        Arts</a>
                                                                </li>
                                                                <li><a href="<?= @$rootPath ?>finance-and-accounting">Finance
                                                                        & Accounting
                                                                    </a>
                                                                </li>
                                                                <li><a
                                                                        href="<?= @$rootPath ?>applied-health-sciences/msc-in-forensic-and-toxicology.php">Forensic
                                                                        Sciences</a>
                                                                </li>
                                                                <li><a
                                                                        href="<?= @$rootPath ?>hotel-management-and-tourism/">Hotel
                                                                ...
                                                                <li><a
                                                                        href="<?= @$rootPath ?>biotechnology/msc-industrial-microbiology.php">Microbiology</a>
                                                                </li>
                                                                <li><a
                                                                        href="<?= @$rootPath ?>design/bachelor-of-design.php">Product
                                                                        &amp; Industrial
                                                                        Design</a>
                                                                </li>
                                                                <li><a
                                                                        href="<?= @$rootPath ?>design/bachelor-of-design-interior.php">Interior
                                                                        Design</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                ...
                                                                <li><a
                                                                        href="<?= @$rootPath ?>management/mba-healthcare-and-life-sciences.php">MBA
                                                                        Healthcare and Hospital Management</a>
                                                                </li>
                                                                <li><a
                                                                ...
                                                                <li><a
                                                                        href="<?= @$rootPath ?>finance-and-accounting/bba-acca.php">BBA
                                                                        with <img
                                                                            data-src="<?= @$imgPath ?>header-footer/acca-header-logo.webp"
                                                                            alt="BBA with ACCA" width="30px"
                                                                            class="lazy-img"></a>
                                                                </li>
                                                                <li><a
                                                                        href="<?= @$rootPath ?>finance-and-accounting/bcom-acca.php">B.Com
                                                                        with <img
                                                                            data-src="<?= @$imgPath ?>header-footer/acca-header-logo.webp"
                                                        ...
                                                        <div class="col-xl-6">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                <li><a
                                                                        href="<?= @$rootPath ?>finance-and-accounting/mcom-acca.php">M.Com
                                                                        with <img
                                                                            data-src="<?= @$imgPath ?>header-footer/acca-header-logo.webp"
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        with <img
                                                                            data-src="<?= @$imgPath ?>header-footer/aon-logo.webp"
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        with <img
                                                                            data-src="<?= @$imgPath ?>header-footer/sas-logo.webp"
                                                                            alt="MBA with SAS" style="margin-top: -3px;"
                                                                            width="30px" class="ptrans lazy-img"></a>
                                                                </li>
                                                                <li><a
                                                                        href="<?= @$rootPath ?>IBM/MBA-business-analytics.php">MBA
                                                                        with <img
                                                                ...
                                                                <li><a
                                                                        href="<?= @$rootPath ?>finance-and-accounting/mba-applied-finance.php">MBA
                                                                        in Applied Finance with <img
                                                                            data-src="<?= @$imgPath ?>header-footer/pwc-logo.jpg"
                                                                            alt="MBA with IBM" style="margin-top: -3px;"
                                                                            width="30px" class="ptrans lazy-img"></a>
                                                                </li>
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        CSE Cloud<br> Computing with <img
                                                                            data-src="<?= @$imgPath ?>header-footer/virtusa-logo.webp"
                                                                ...
                                                                <li><a href="<?= @$rootPath ?>bfe/">MBA with <img
                                                                            ...
                                                                            width="90px" class="ptrans lazy-img"></a>
                                                                </li>
                                                                ...
                                                                <li><a
                                                                        href="<?= @$rootPath ?>management/mba-fintech.php">MBA
                                                                        Fintech with <img
                                                                ...
                                                                <li><a
                                                                        href="<?= @$rootPath ?>management/MBA-logistics-and-supply-chain-management.php">MBA
                                                                        Logistics and<br> Supply Chain Management<br>
                                                                        with
                                                                        <img data-src="<?= @$imgPath ?>header-footer/cii-logo.webp"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                <li><a href="<?= @$rootPath ?>doctorate-programs/">Doctor
                                                                        of Philosophy</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                <li><a href="<?= @$rootPath ?>studyabroad/">Canada</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                <li><a
                                                                        href="<?= @$rootPath ?>studyabroad/">Australia</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-lg-6">
                                                            <div class="card br-6 p-3">
                                                                <a href="https://www.cuidol.in/?utm_source=Website&utm_medium=cuchd"
                                                                    target="_blank"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="card br-6 p-3">
                                                                <a href="https://www.onlinecu.in/?utm_source=Website&utm_medium=cuchd"
                                                                    target="_blank"
                                                                    class="position-relative text-dark text-uppercase"><small>Click
                                                                        here to view Programs
                                        ...
                                        <div class="col-xl-3 col-lg-12 pg-bg program-graphic d-none d-lg-block lazy-bg"
                                            style="background: url('<?= @$imgPath ?>header-footer/lazy-program-dd-image.webp'); margin: -20px -20px -20px 20px; background-size: cover;"
                                            data-bg="<?= @$imgPath ?>header-footer/program-dd-image.webp">
                                                    ...
                                                    <div class="row g-2">
                                                        ...
                                                        <div class="col-4 col-xl-12">
                                                            <div class="card p-2">
                                                                <span>
                                                                    <h4 id="high-pk"><span
                                                                            class="d-none"></span><?= @$highestpackage ?>
                                                                        <sub>CR
                                                                        </sub>
                                                                    </h4>
                                                        ...
                                                        <div class="col-4 col-xl-12">
                                                            <div class="card p-2">
                                                                <span>
                                                                    <h4 id="high-npk"><span
                                                                            class="d-none"></span><?= @$nationalpackage ?>
                                                                        <sub>LPA</sub>
                                                                    </h4>
                                    ...
                                    <div class="row g-0 h-100">
                                        <div class="col-lg-5">
                                            ...
                                            <ul class="list-unstyled p-0 m-0">
                                                ...
                                                <li><a href="<?= @$rootPath ?>academics/institutes.php">Institutes</a>
                                                </li>
                                                <li><a href="<?= @$rootPath ?>admissions/course-fee.php">Program
                                                        (Courses)</a>
                                                </li>
                                                ...
                                                <li><a href="<?= @$rootPath ?>academics/system-of-evaluation.php">System
                                                        of
                                                        Evaluation</a>
                                                </li>
                                                ...
                                                <li><a href="<?= @$rootPath ?>professors-of-practice/index.php">Professors
                                                        of
                                                        Practice</a>
                                                </li>
                                            </ul>
                                ...
                                <div class="step-second-menu st-admissions">
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="list-unstyled p-0 m-0">
                                                        <li><a href="<?= @$rootPath ?>admissions/after12th.php">After
                                                                12th</a>
                                                        </li>
                                                        ...
                                                        <li><a
                                                                href="<?= @$rootPath ?>admissions/specialized-programs.php">Specialized
                                                                Programs</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= @$rootPath ?>admissions/integrated-programs.php">Integrated
                                                                Programs</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= @$rootPath ?>admissions/afterpostgraduation.php">After
                                                                Post Graduation</a>
                                                        </li>
                                                        <li><a href="<?= @$rootPath ?>admissions/cu-advantages.php">CU
                                                                Advantages</a>
                                                        </li>
                                                        <li><a href="<?= @$rootPath ?>abet/">ABET Engineering
                                                                Accreditation</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <ul class="list-unstyled p-0 m-0">
                                                        ...
                                                        <li><a href="<?= @$rootPath ?>admissions/how-to-apply.php">How
                                                                to
                                                                Apply?</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= @$rootPath ?>admissions/admission-criteria.php">Admission
                                                                Criteria</a>
                                                        </li>
                                                        <li><a href="<?= @$rootPath ?>scholarship/">CU Scholarship</a>
                                                        </li>
                                                        <li><a href="<?= @$rootPath ?>admissions/education-loan.php">Education
                                                                Loan</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= @$rootPath ?>student-services/hostel-facility.php">Hostel
                                                                Fee</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-xl-6">
                                                    <ul class="list-unstyled p-0 m-0">
                                                        ...
                                                        <li><a href="<?= @$rootPath ?>contact/">Visit the Campus</a>
                                                        </li>
                                                        <li><a href="<?= @$rootPath ?>migration/">Migration Policy</a>
                                                        </li>
                                    ...
                                    <div class="d-none d-xl-block" style="margin: 65px -20px 0 -20px;">
                                        <div class="redbox-applynow position-relative seagreen-overlay-faded lazy-bg"
                                            style="background-image: url(<?= @$imgPath ?>header-footer/lazy-unique3-bg.webp);"
                                            data-bg="<?= @$imgPath ?>header-footer/unique3-bg.webp">
                            ...
                            <li class="nav-item dd-menu-lg">
                                ...
                                <div class="step-second-menu st-campus">
                                    <div class="d-none d-xl-block" style="margin: -20px -20px 15px -20px;">
                                        <div class="redbox-applynow position-relative seagreen-overlay-faded lazy-bg"
                                            style="background-image: url(<?= @$imgPath ?>header-footer/lazy-campus-bg.webp);"
                                            data-bg="<?= @$imgPath ?>header-footer/campus-bg.webp">
                                            <div class="position-relative">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="list-unstyled p-0 m-0">
                                                        ...
                                                        <li><a href="<?= @$rootPath ?>campus-life/tech-invent.php">Tech
                                                                Invent
                                                                &amp; Events</a>
                                                        </li>
                                                        ...
                                                        <li><a href="<?= @$rootPath ?>campus-life/evoke.php">Evoke &amp;
                                                                Youth
                                                                Summits</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= @$rootPath ?>campus-life/glorious-stars-cu.php">Glorious
                                                                Stars at CU</a>
                                                        </li>
                                                        <li><a href="<?= @$rootPath ?>student-services/sports.php">Sports
                                                                &amp; Adventure</a>
                                                        </li>
                                                        <li><a href="<?= @$rootPath ?>latest-news/index.php">Latest
                                                                News</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="list-unstyled p-0 m-0">
                                                        <li><a
                                                                href="<?= @$rootPath ?>campus-life/bollywood-celebrities.php">Bollywood
                                                                Celebrities</a>
                                                        </li>
                                                        ...
                                                        <li><a
                                                                href="<?= @$rootPath ?>campus-life/canadian-alumni-meet.php">Canadian
                                                                Alumni Chapter</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <div class="step-second-menu st-placements">
                                    <div class="row g-0 h-100">
                                        <div class="col-lg-6 d-none d-xl-block lazy-bg"
                                            style="background: url('<?= @$imgPath ?>header-footer/lazy-placement-bg.webp'); margin: -20px 20px -20px -20px;  background-size: cover;"
                                            data-bg="<?= @$imgPath ?>header-footer/placement-bg.webp">
                                            <div class="drop-down-graphic position-relative h-100">
                                                            ...
                                                            <div class="dd--title align-self-center mx-auto">
                                                                <span>
                                                                    <img class="w-100 lazy-img"
                                                                        data-src="<?= @$imgPath ?>header-footer/mahindra-logo-dark.webp">
                                                                </span>
                                                                Mahindra
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <ul class="list-unstyled p-0 m-0">
                                                ...
                                                <li><a
                                                        href="<?= @$rootPath ?>placements/placement_hotel_management.php">Best
                                                ...
                                                <li><a href="<?= @$rootPath ?>placement-offers-by-tcs/index.php">Best
                                                        TCS Placement</a>
                                                </li>
                                                <li><a href="<?= @$rootPath ?>placements/placement-day.php">Placement
                                                        Day</a>
                                                </li>
                                                <li><a href="<?= @$rootPath ?>placements/placement-overview.php">Our
                                                        Leading
                                                        Recruiters</a>
                                                </li>
                                            </ul>
                            ...
                            <li class="nav-item dd-menu-lg">
                                ...
                                <div class="step-second-menu st-research">
                                    <div class="row g-0 h-100">
                                        <div class="col-lg-6 d-none d-xl-block lazy-bg"
                                            style="background: url('<?= @$imgPath ?>header-footer/lazy-research-bg.webp'); margin: -20px 20px -20px -20px; background-size: cover;"
                                            data-bg="<?= @$imgPath ?>header-footer/research-bg.webp">
                                            <div
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="list-unstyled p-0 m-0">
                                                        ...
                                                        <li><a href="<?= @$rootPath ?>research/patents.php">Patents</a>
                                                        </li>
                                                        <li><a href="<?= @$rootPath ?>research/center-of-research.php">Centers
                                                                Of Research</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= @$rootPath ?>research/centers-of-excellence.php">Centers
                                                                of Excellence</a>
                                                        </li>
                                                        ...
                                                        <li><a
                                                                href="<?= @$rootPath ?>usb/business-management/research-journal.php">CU
                                                                Global Management Review</a>
                                                        </li>
                                                        <li><a
                                                                href="<?= @$rootPath ?>uils/legal-studies/research-journal.php">CU
                                                                Law Review</a>
                                                        </li>
                                                        <!-- <li><a href="<?= @$rootPath ?>ignite/"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="list-unstyled p-0 m-0">
                                                        <li><a href="<?= @$rootPath ?>technology-business-incubator/index.php"
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/engg-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/engg-institute-bg-small.webp">
                                            </div>
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/management-institute-bg.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/management-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/computing-institute-bg.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/computing-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/pharma-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/pharma-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/bio-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/bio-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/arch-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/arch-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/liberal-institute-bg.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/liberal-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/uifva-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/uifva-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/uittr-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/uittr-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/legal-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/legal-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/media-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/media-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/uis-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/uis-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/ahs-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/ahs-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/design-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/design-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/uithm-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/uithm-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/gsfa-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/gsfa-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/cassm-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/cassm-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-big.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/pes-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('<?= @$imgPath ?>header-footer/institute-bg-small.webp');"
                                                data-bg="<?= @$imgPath ?>header-footer/pes-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
