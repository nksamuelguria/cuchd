...
header.sticky .nav-item.dd-menu-lg:hover > a::before {
	top: 6px;
}
...
.institute-list ul li:hover a::after, .institute-list ul li.active a::after {
    width: 0;
}
.institute-list ul li:hover a::before, .institute-list ul li.active a::before {
    background: var(--pale-yellow);
    width: 100%;
}  
.institute-info-sec {
...
.step-first-menu > li:hover .step-second-menu.institute-info-sec, .step-first-menu > li.active .step-second-menu.institute-info-sec {
    transform: rotateY(0);
}  
...
.seagreen-overlay-faded::before {
	background: var(--seagreen-gradient-faded);
    content: '';
    position: absolute;
    left: 0;
    right: 0;
...
#search-page-mob {
	border: 1px solid var(--white-opacity-bg);
	padding: 4px 12px;
	border-radius: 6px;
    display: flex;
    align-items: center;
...
.header_btn .navbar-toggler[aria-expanded="true"] .navbar-toggler-icon {
	width: 19px;
	height: 19px;
	background-image: url(<?=@$imgPath?>header-footer/toggler-close.png);
} 
#sb_chat_btn {
...
.header_btn .navbar-toggler {
    ...
    .header_btn .navbar-toggler[aria-expanded="true"] {
        padding: 25px 15px;
    }    
    .header_btn .navbar-toggler[aria-expanded="true"] .navbar-toggler-icon {
        width: 14px;
    ...
    header.sticky .header_btn .navbar-toggler {
        top: 0;
    }    
    header.sticky .header_btn {
        padding: 18px 20px;
        margin: -44px -12px -43px 0;
    }    
    .menu-options {
    ...
    .institute-content .btn.btn-primary {
	   white-space: nowrap;
    }     
}
    @media (min-width: 1200px) and (max-width: 1250px) {
        .header .nav-item>a{font-size:11px!important}    
.menu-options li a {
...
.header__top-left, .header.sticky .header__top-left {
	width: auto;  
}    
...
@media only screen and (max-width:1730px){
    #navbarToggleExternalContent .mega-menu, .institute-info-sec {
        height: 103vh;
    }  
    header.sticky .menu-options {
        right: 452px;
...
@media only screen and (max-width:1199px){
    .header_btn, header.sticky .header_btn {
        margin: auto;
    }   
    .header_btn .navbar-toggler, .header_btn::before {
        display: none !important;
    }    
    .header_btn .navbar-toggler .navbar-toggler-icon {
    ...
    .header__top-right ul{width:100%;justify-content:space-between}    
.hts-text {
	display: inline-block;
}    
    #navbarToggleExternalContent .mega-menu {
    ...
    .institute-list .step-first-menu {
        width: auto;
    }
    .institute-list ul {
	   padding-right: 25px;
...
@media only screen and (max-width:430px){
    #search-page-mob .fa.fa-search.ms-3 {
        ...
        <nav class="navbar navbar-expand-xl">
            <div class="container-fluid align-items-center">
                <div class="navbar-brand p-0 d-flex align-items-center">
                    <a href="https://www.cuchd.in/" aria-label="Go to Chandigarh University's Home Page"><img src="<?=@$imgPath?>header-footer/cu-logo-white.webp" alt="" width="192" class="me-2 cu-logo"></a>
                    <div class="navbar-brand__slider ms-2">
                        <div class="nbs-item">
                            <img src="<?=@$imgPath?>header-footer/qs-logo-white.webp" alt="" width="138">
                        </div>
                        <div class="nbs-item">
                            <img src="<?=@$imgPath?>header-footer/naac-a-logo.webp" alt="" width="138">
                        </div>
                    </div>
                </div>
                <button id="main-toggler" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"
                    ...
                    <ul class="navbar-nav m-auto step-first-menu">
                                ...
                                <div class="row g-0 h-100">
                                    <div class="col-xl-4">
                                        ...
                                        <ul class="list-unstyled p-0 m-0">
                                            <li><a href="<?=@$rootPath?>about/">Overview</a></li>
                                            <li><a href="<?=@$rootPath?>about/our-identity.php">Our Identity</a></li>
                                            <li><a href="<?=@$rootPath?>about/vision-and-mission.php">Vision &amp;
                                                Mission</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>about/LeaderShip.php">LeaderShip</a></li>
                                            <li><a href="<?=@$rootPath?>core-values/">Core Values</a></li>
                                            <li><a href="<?=@$rootPath?>recognitions-and-approvals/">Recognition &amp;
                                                Approvals</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>about/Awards-and-Rankings.php">Awards &amp;
                                                Rankings</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>about/institution-social-responsibility.php">Institutional
                                                Social Responsibility</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>admissions/cu-edge.php">CU Edge</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-xl-4">
                                        <h4>Related Links</h4>
                                        <ul class="list-unstyled p-0 m-0">
                                            <li><a href="<?=@$rootPath?>academics/institutes.php">Institutes &amp;
                                                Departments</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>admissions/">Admissions</a></li>
                                            <li><a href="<?=@$rootPath?>scholarship/">Scholarships</a></li>
                                            <li><a href="<?=@$rootPath?>about/governance.php">Governance</a></li>
                                            
                                            <li><a href="<?=@$rootPath?>student-services/hostel-facility.php">Hostel
                                                Facility</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>student-services/">Student Services</a></li>
                                            <li><a href="<?=@$rootPath?>contact/how-to-reach-us.php">How to Reach
                                                Us?</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>GATI-charter-institution.php">GATI Charter
                                                Institution</a>
                                            </li>
											<li><a href="<?=@$rootPath?>abet/">ABET Engineering Accreditation</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4 about-graphic d-none d-lg-block lazybg"
                                        style="background: url('<?=@$imgPath?>header-footer/lazy-about-dd-image.webp'); margin: -20px -20px -20px 20px;  background-size: cover;" data-src="<?=@$imgPath?>header-footer/about-dd-image.webp">
                            ...
                            <div class="step-second-menu st-programs">
                                <div class="row h-100 g-0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a href="<?=@$rootPath?>engineering/">Engineering</a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>management/">Management
                                                                (BBA/MBA)</a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>computing/">Computing (BCA/ MCA)</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>hotel-management-and-tourism/bsc-airline-and-airport-management.php">Airlines
                                                                &amp; Airport Management</a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>animation-and-multimedia/">Animation
                                                                &amp; Multimedia</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>applied-health-sciences/">Allied
                                                                Health Sciences</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>architecture-and-design/">Architecture</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>liberal-arts-and-humanities/">Arts
                                                                &amp; Humanities</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>basic-sciences/">Basic
                                                                Sciences</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>liberal-arts-and-humanities/bachelor-of-arts-liberal-arts.php">BA
                                                                (Hons.) Liberal Arts</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>engineering/be-industrial-internet-of-things.php">B.E. (Industrial Internet of Things)</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>biotechnology/">Biotechnology &amp; Biosciences</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a href="<?=@$rootPath?>basic-sciences/">Chemistry/ Physics/ Mathematics</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>commerce/">Commerce (B.Com/
                                                                M.Com)</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>hotel-management-and-tourism/bsc-culinary-arts.php">Culinary
                                                                Sciences</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>basic-sciences/msc-data-sciences.php">Data
                                                                Science</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>commerce/">Economics</a></li>
															<li><a
                                                                href="<?=@$rootPath?>teachers-training-and-research/">Education</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>design/bachelor-of-design-fashion.php">Fashion
                                                                &amp; Design</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>design/fine-arts.php">Fine
                                                                Arts</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>applied-health-sciences/msc-in-forensic-and-toxicology.php">Forensic Sciences</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>hotel-management-and-tourism/">Hotel
                                                                &amp; Hospitality Management</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>IBM">IBM Specialized
                                                                CSE Programs</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>biotechnology/msc-industrial-microbiology.php">Industrial
                                                                Microbiology</a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>design/bachelor-of-design.php">Industrial
                                                                Design</a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>design/bachelor-of-design-interior.php">Interior
                                                                Design</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a href="<?=@$rootPath?>legal-studies/">Legal
                                                                Studies</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>management/mba-healthcare-and-life-sciences.php">MBA Healthcare and Life Sciences</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>management/MBA-tourism-and-hospitality-management.php">MBA
                                                                Tourism &amp; Hospitality</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>applied-health-sciences/bsc-in-mlt.php">Medical
                                                                Lab Technology</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>journalism-and-mass-communication/">Media
                                                                Studies</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>applied-health-sciences/bsc-nutrition-dietetics.php">Nutrition
                                                                &amp; Dietetics</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>applied-health-sciences/bachelor-of-optometry.php">Optometry</a>
                                                            </li>
															<li><a href="<?=@$rootPath?>pharma-sciences/">Pharma
                                                                Sciences</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>applied-health-sciences/bachelor-of-physiotherapy.php">Physiotherapy</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>liberal-arts-and-humanities/ma-psychology.php">Psychology</a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>hotel-management-and-tourism/bsc-travel-and-tourism-management.php">Travel
                                                                and Tourism</a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>finance-and-accounting/bba-acca.php">BBA with <img data-src="<?=@$imgPath?>header-footer/acca-header-logo.webp" alt="BBA with ACCA" width="30px" class="lazyload"></a></li>
															<li><a href="<?=@$rootPath?>finance-and-accounting/bcom-acca.php">B.Com with <img data-src="<?=@$imgPath?>header-footer/acca-header-logo.webp" alt="B.Com with ACCA" width="30px" class="lazyload"></a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a href="<?=@$rootPath?>finance-and-accounting/mcom-acca.php">M.Com with <img data-src="<?=@$imgPath?>header-footer/acca-header-logo.webp" alt="M.Com with ACCA" width="30px" class="lazyload"></a></li>
                                                            <li><a
                                                                href="<?=@$rootPath?>management/mba-strategic-hr.php">MBA
                                                                with <img data-src="<?=@$imgPath?>header-footer/aon-logo.webp"
                                                                    alt="MBA with AON" width="36px"
                                                                    class="ptrans lazyload"></a>
                                                            </li>
															<li><a
                                                                href="<?=@$rootPath?>management/mba-data-science-and-artificial-intelligence.php">MBA
                                                                with <img data-src="<?=@$imgPath?>header-footer/sas-logo.webp"
                                                                    alt="MBA with SAS" style="margin-top: -3px;"
                                                                    width="30px" class="ptrans lazyload"></a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>IBM/MBA-business-analytics.php">MBA
                                                                with <img data-src="<?=@$imgPath?>header-footer/IBM-logo.webp"
                                                                    alt="MBA with IBM" style="margin-top: -3px;"
                                                                    width="30px" class="ptrans lazyload"></a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>IBM/">CSE with <img
                                                                data-src="<?=@$imgPath?>header-footer/IBM-logo.webp"
                                                                alt="MBA with IBM" style="margin-top: -3px;"
                                                                width="30px" class="ptrans lazyload"></a></li>
                                                            <li><a
                                                                href="<?=@$rootPath?>engineering/virtusa-me-cse-cloud-computing.php">ME
                                                                CSE Cloud<br> Computing with <img data-src="<?=@$imgPath?>header-footer/virtusa-logo.webp"
                                                                    alt="ME CSE with Virtusa"
                                                                    style="margin-top: -4px;" width="50px"
                                                                    class="ptrans lazyload"></a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>bfe/">MBA with <img
                                                                data-src="<?=@$imgPath?>header-footer/SBI-logo.webp"
                                                                alt="MBA with SBI" style="margin-top: -3px;"
                                                                width="90px" class="ptrans lazyload"></a></li>
                                                            <li><a href="<?=@$rootPath?>TCS/">CSE with <img
                                                                data-src="<?=@$imgPath?>header-footer/TCS-logo.webp"
                                                                alt="MBA with TCS" style="margin-top: -1px;"
                                                                width="130px" class="ptrans lazyload"></a></li>
                                                            <li><a
                                                                href="<?=@$rootPath?>management/bba-business-analytics.php">BBA
                                                                with <img data-src="<?=@$imgPath?>header-footer/sas-logo.webp"
                                                                    alt="BBA with SAS" style="margin-top: -3px;"
                                                                    width="30px" class="ptrans lazyload"></a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>management/mba-fintech.php">MBA
                                                                Fintech with <img
                                                                    data-src="<?=@$imgPath?>header-footer/nse-acadmey.webp"
                                                                    alt="MBA with Fintech" style="margin-top: -2px;"
                                                                    width="36px" class="ptrans lazyload"></a>
                                                            </li>
                                                            <li><a href="<?=@$rootPath?>management/MBA-logistics-and-supply-chain-management.php">MBA
                                                                Logistics and<br> Supply Chain Management<br> with <img
                                                                    data-src="<?=@$imgPath?>header-footer/cii-logo.webp"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a
                                                                href="<?=@$rootPath?>doctorate-programs/">Doctor
                                                                of Philosophy</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a
                                                                href="<?=@$rootPath?>phd-me-admissions/ApplicationRegistration.aspx?Subject=fJAt3RX8ggEX//eDGysKyA==">Ph.D
                                                                Admissions</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a href="<?=@$rootPath?>studyabroad/">Canada</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a href="<?=@$rootPath?>studyabroad/">USA</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <ul class="list-unstyled p-0 m-0">
                                                            <li><a href="<?=@$rootPath?>studyabroad/">Australia</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-12 pg-bg program-graphic d-none d-lg-block lazybg"
                                        style="background: url('<?=@$imgPath?>header-footer/lazy-program-dd-image.webp'); margin: -20px -20px -20px 20px; background-size: cover;" data-src="<?=@$imgPath?>header-footer/program-dd-image.webp">
                            ...
                            <div class="step-second-menu st-academics">
                                <div class="row g-0 h-100">
                                    <div class="col-lg-5">
                                        <h4>Academics</h4>
                                        <ul class="list-unstyled p-0 m-0">
                                            <li><a href="<?=@$rootPath?>academics/">Academics Overview</a></li>
                                            <li><a href="<?=@$rootPath?>academics/institutes.php">Institutes</a></li>
                                            <li><a href="<?=@$rootPath?>admissions/course-fee.php">Program (Courses)</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>academics/academic-calendar-odd.php">Academic
                                                Calendar</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>academics/list-of-holidays.php">List of
                                                Holidays</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>academics/teaching-practices.php">Teaching
                                                Practices</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>academics/system-of-evaluation.php">System of
                                                Evaluation</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>professional-bodies/index.php">Professional
                                                Bodies</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>professors-of-practice/index.php">Professors of
                                                Practice</a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <li class="nav-item dd-menu-lg">
                            ...
                            <div class="step-second-menu st-admissions">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="list-unstyled p-0 m-0">
                                                    <li><a href="<?=@$rootPath?>admissions/after12th.php">After 12th</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>admissions/aftergraduation.php">After
                                                        Graduation</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>admissions/LEET-programs.php">Leet
                                                        Programs</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>admissions/specialized-programs.php">Specialized
                                                        Programs</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>admissions/integrated-programs.php">Integrated
                                                        Programs</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>admissions/afterpostgraduation.php">After
                                                        Post Graduation</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>admissions/cu-advantages.php">CU Advantages</a>
                                                    </li>
													<li><a href="<?=@$rootPath?>abet/">ABET Engineering Accreditation</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-8 col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <ul class="list-unstyled p-0 m-0">
                                                    <li><a href="<?=@$rootPath?>admissions/">Overview</a></li>
                                                    <li><a href="<?=@$rootPath?>admissions/course-fee.php">Course
                                                        Fee</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>admissions/how-to-apply.php">How to
                                                        Apply?</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>admissions/admission-criteria.php">Admission
                                                        Criteria</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>scholarship/">CU Scholarship</a></li>
                                                    <li><a href="<?=@$rootPath?>admissions/education-loan.php">Education
                                                        Loan</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>student-services/hostel-facility.php">Hostel
                                                        Fee</a>
                                                    </li>
													<li><a href="<?=@$rootPath?>admissions/admissions-status.php">Admissions Status</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-xl-6">
                                                <ul class="list-unstyled p-0 m-0">
                                                    ...
                                                    <li><a href="<?=@$rootPath?>international/international.php">International
                                                        Admissions</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>contact/index.php#ad-off">Admission
                                                        Offices</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>contact/">Visit the Campus</a></li>
                                                    <li><a href="<?=@$rootPath?>migration/">Migration Policy</a></li>
                                                    <li><a href="<?=@$rootPath?>refund/">Refund Policy</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-none d-lg-block" style="margin: 0 -20px 0 -20px;">
                                    <div class="redbox-applynow position-relative seagreen-overlay-faded lazybg" style="background-image: url(<?=@$imgPath?>header-footer/lazy-unique3-bg.webp);" data-src="<?=@$imgPath?>header-footer/unique3-bg.webp">
                        ...
                        <li class="nav-item dd-menu-lg">
                            ...
                            <div class="step-second-menu st-campus">
                                <div class="d-none d-lg-block" style="margin: -20px -20px 15px -20px;">
                                    <div class="redbox-applynow position-relative seagreen-overlay-faded lazybg"
                                        style="background-image: url(<?=@$imgPath?>header-footer/lazy-campus-bg.webp);" data-src="<?=@$imgPath?>header-footer/campus-bg.webp">
                                        <div class="position-relative">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="list-unstyled p-0 m-0">
                                                    <li><a
                                                        href="<?=@$rootPath?>campus-life/index.php">Overview</a>
                                                    </li>
                                                    <li><a
                                                        href="<?=@$rootPath?>campus-life/convocation.php">Convocations</a>
                                                    </li>
                                                    <li><a
                                                        href="<?=@$rootPath?>campus-life/live-concerts.php">Live-in-Concerts</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>campus-life/tech-invent.php">Tech Invent
                                                        &amp; Events</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>campus-life/cultural.php">Cultural &amp;
                                                        Cosmopolitan</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>campus-life/evoke.php">Evoke &amp; Youth
                                                        Summits</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>campus-life/glorious-stars-cu.php">Glorious
                                                        Stars at CU</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>student-services/sports.php">Sports
                                                        &amp; Adventure</a>
                                                    </li>
													<li><a href="<?=@$rootPath?>latest-news/index.php">Latest News</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="list-unstyled p-0 m-0">
                                                    <li><a href="<?=@$rootPath?>campus-life/bollywood-celebrities.php">Bollywood
                                                        Celebrities</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>campus-life/visitors.php">Prominent
                                                        Visitors</a>
                                                    </li>
                                                    <li><a
                                                        href="<?=@$rootPath?>campus-life/international-folklore-festival.php">CU-RHYTHMS
                                                        International Folklore Festival</a>
                                                    </li>
                                                    <li><a
                                                        href="<?=@$rootPath?>campus-life/national-international-conferences.php">National
                                                        &amp; International Conferences</a>
                                                    </li>
                                                    <li><a
                                                        href="<?=@$rootPath?>campus-life/international-faculties.php">International
                                                        Faculties</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>campus-life/alumni.php">Notable
                                                        Alumni</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>campus-life/canadian-alumni-meet.php">Canadian
                                                        Alumni Chapter</a>
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            <div class="step-second-menu st-placements">
                                <div class="row g-0 h-100">
                                    <div class="col-lg-6 d-none d-lg-block lazybg"
                                        style="background: url('<?=@$imgPath?>header-footer/lazy-placement-bg.webp'); margin: -20px 20px -20px -20px;  background-size: cover;" data-src="<?=@$imgPath?>header-footer/placement-bg.webp">
                                        <div class="drop-down-graphic position-relative h-100">
                                            ...
                                            <div class="dd-graphic-cont position-absolute bottom-0 w-100">
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-6 p-2 py-3 d-flex">
                                                        <div class="dd--title align-self-center mx-auto">
                                                            <span>
                                                                <img class="w-100 lazyload" data-src="<?=@$imgPath?>header-footer/mahindra-logo-dark.webp">
                                                            </span>
                                                            Mahindra
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <h4>Placements</h4>
                                        <ul class="list-unstyled p-0 m-0">
                                            <li><a href="<?=@$rootPath?>placements/">About Placements</a></li>
                                            <li><a href="<?=@$rootPath?>placements/placement-tracker.php">Placement
                                                Tracker</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>department-of-career-development/index.html"
                                                target="_blank">Department of Career Planning &amp; Development</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>placements/joint-placement-programme.php">Joint
                                                Placement Programme</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>placements/placement_engineering.php">Best
                                                Engineering Placement</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>placements/placement_management.php">Best
                                                Management Placement</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>placements/placement_hotel_management.php">Best
                                                Hotel Management Placement</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>placements/placement-pharma-sciences.php">Best
                                                Pharma Sciences Placement</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>placements/placement-physics.php">Best
                                                Physics Placement</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>placements/placement-day.php">Placement Day</a>
                                            </li>
                                            <li><a href="<?=@$rootPath?>placements/placement-overview.php">Our Leading
                                                Recruiters</a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <li class="nav-item dd-menu-lg">
                            ...
                            <div class="step-second-menu st-research">
                                <div class="row g-0 h-100">
                                    <div class="col-lg-6 d-none d-lg-block lazybg"
                                        style="background: url('<?=@$imgPath?>header-footer/lazy-research-bg.webp'); margin: -20px 20px -20px -20px; background-size: cover;" data-src="<?=@$imgPath?>header-footer/research-bg.webp">
...
">Our<br> Intellectual <br>Pursuits</h3>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="list-unstyled p-0 m-0">
                                                    <li><a href="<?=@$rootPath?>research/">Research</a></li>
                                                    <li><a href="<?=@$rootPath?>research/patents.php">Patents</a></li>
                                                    <li><a href="<?=@$rootPath?>research/center-of-research.php">Centers
                                                        Of Research</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>research/centers-of-excellence.php">Centers
                                                        of Excellence</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>research/scholars.php">Visiting
                                                        Scholars</a>
                                                    </li>
                                                    <li><a href="<?=@$rootPath?>usb/business-management/research-journal.php">CU Global Management Review</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="list-unstyled p-0 m-0">
                                                    ...
                                                    <li><a href="<?=@$rootPath?>research/entrepreneurship.php">Innovation
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="list-unstyled p-0 m-0">
                                                    <li><a href="<?=@$rootPath?>research/sdg">Policies &amp;
                                                        Strategies</a>
                                                    </li>
                                                </ul>
                                            </div>
                    ...
                    <ul class="menu-options d-flex list-unstyled m-0 p-0">
                        <li class="m-0"><a href="<?=@$rootPath?>international/index.php">International</a></li>
                        <li><a href="<?=@$rootPath?>student-services/libraries.php">Library</a></li>
                        <li><a href="<?=@$rootPath?>student-services/">Student Services</a></li>
                        <li><a href="<?=@$rootPath?>jobs/">Career</a></li>
                        <li><a href="https://alumni.cuchd.in/">Alumni</a></li>
                        <li><a href="<?=@$rootPath?>contact/index.php"> Contact Us</a></li>
                    </ul>
                    <div class="d-flex header_btn blue-gradient">
                        <a href="tel:+1800121288800" class="d-flex align-items-center text-white">
                            <img src="<?=@$imgPath?>header-footer/phone-icon.webp" alt="" width="30">
                            <span class="d-block ms-2">
                                <small class="d-block text-capitalize">Admission Helpline</small>1800121288800
                            </span>                         
                        </a>
                        <button class="navbar-toggler d-flex" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
                          <span class="navbar-toggler-icon"></span>
                        </button>
                    </div>                  
                </div>
    ...
    <div class="header__top d-flex justify-content-between align-items-center">
        <div class="header__top-right d-flex">
            <ul class="d-flex list-unstyled p-0 m-0">
                ...
                <li><a href="<?=@$rootPath?>whatsapp.php" target="_blank" aria-label="Call on CU's Whatsapp"><i class="fa-brands fa-whatsapp"></i></a></li>
                <li class="ph-missed"><a href="tel:8033094409" aria-label="Give a miss call"><i class="fa-solid fa-phone" style="font-size: 12px"></i></a></li>
                <li><a href="<?=@$rootPath?>maps/" id="vt-bt" class="text360"><i class="fa-solid fa-compass" style="font-size: 12px"></i><small class="ms-1">360<sup>o</sup></small></a></li>
                <li class="ms-5 hts-text">Get Social</li>
                <li><a href="https://www.facebook.com/chandigarhuniversitygharuan" target="_blank" aria-label="Go to Chandigarh University's Facebook Page"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="https://www.twitter.com/chandigarh_uni" target="_blank" aria-label="Go to Chandigarh University's Twitter (X) Page"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="https://www.linkedin.com/school/chandigarh-university/" target="_blank" aria-label="Go to Chandigarh University's Linkedin Page"><i class="fa-brands fa-linkedin-in"></i></a></li>
                <li><a href="https://www.instagram.com/chandigarhuniversity" target="_blank" aria-label="Go to Chandigarh University's Instagram Page"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="https://www.youtube.com/user/chandigarhuniversity" target="_blank" aria-label="Go to Chandigarh University's Youtube Page"><i class="fa-brands fa-youtube"></i></a></li>
                <li><a href="https://www.threads.net/@chandigarhuniversity" target="_blank" aria-label="Go to Chandigarh University's Threads Page"><img src="<?=@$imgPath?>header-footer/threads-icon.webp" alt="" height="13" class="h-thread-icon"></a></li>
                <!--<li class="ms-5 head-search"><a href="javascript:void(0);" id="search-page-mob" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-label="Search Chandigarh University Website"><i class="fa fa-search me-1" aria-hidden="true"></i><small>Search</small></a></li>-->
            </ul>
        </div>        
        <div class="header__top-left">
            <ul class="list-unstyled p-0 m-0">
                <li class="ms-5 head-search"><a href="javascript:void(0);" id="search-page-mob" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-label="Search Chandigarh University Website" class="text-white"><small>Search</small><i class="fa fa-search ms-3" aria-hidden="true"></i></a></li>            
            </ul>
<!--
                            ...
                            <ul class="list-unstyled step-first-menu hover-header-list ps-0">
                                <li class="active">
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/engg-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/engg-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/engg-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/engg-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">A New Era in Engineering Education awaits you with dynamic experiential learning and a flexible academic model.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                            </div>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/management-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/management-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/management-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/management-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Embark on your path to corporate leadership with world-class facilities, research focus, innovation culture &amp; entrepreneurial zeal.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/computing-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/computing-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/computing-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/computing-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Gain the ultimate toolkit for success in computing with our versatile degree and hands-on learning experience.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/pharma-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/pharma-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/pharma-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/pharma-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Seize the unparalleled opportunity to become a future Healthcare Pro &amp; immerse yourself in a clinically focused, science-driven course.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    <a href="/biotchnology/">University Institute of Biotechnology</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/bio-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/bio-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/bio-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/bio-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Dive into the fascinating world of Biotechnology and Biosciences within our research-oriented environment.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/arch-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/arch-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/arch-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/arch-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Master architecture as core professionals with cutting-edge tech and insights from the global community.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    <a href="/liberal-arts-and-humanities/">University Institute of Liberal Arts &amp; Humanities</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/liberal-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/liberal-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/liberal-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/liberal-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Step into a hub of cultural diversity, where learning centers on critical thinking, creativity, research, and communication skills.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    <a href="/animation-and-multimedia/">University Institute of Film and Visual Arts</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/uifva-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/uifva-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/uifva-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/uifva-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Experience next-gen multimedia education, merging technology with traditional art for the next generation of industry leaders.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    <a href="/teachers-training-and-research/">University Institute of Teachers Training And Research</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/uittr-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/uittr-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/uittr-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/uittr-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Your pathway to becoming an exceptional educator with NCTE approval, collaborative partnerships and much more.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/legal-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/legal-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/legal-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/legal-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Become a top-notch Legal Professional a blend of tradition and modernity in Legal Education.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    <a href="/journalism-and-mass-communication/">University Institute of Media Studies</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/media-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/media-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/media-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/media-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Your path to industry-ready media professionalism with hands-on training, a dynamic environment &amp; global collaborations.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/uis-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/uis-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/uis-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/uis-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Be a future leader with a pioneering blend of academic excellence, research endeavors, and hands-on learning.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    <a href="/applied-health-sciences/">University Institute of Applied Health Sciences</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/ahs-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/ahs-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/ahs-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/ahs-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Lead the forefront of Allied Health Sciences with a clinically focused curriculum and immersive learning experience.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/design-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/design-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/design-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/design-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Embark on your journey with our comprehensive Design programs, guided by experienced faculty &amp; tailored for success.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    <a href="/hotel-management-and-tourism/">University Institute of Tourism &amp; Hospitality Management</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/uithm-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/uithm-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/uithm-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/uithm-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Lead the way in hospitality education with cutting-edge training, facilities &amp; a unique blend of theoretical knowledge &amp; real-world experience.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/gsfa-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/gsfa-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/gsfa-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/gsfa-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Unveil a revolutionary approach to finance education with dynamic experiential learning.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/cassm-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/cassm-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/cassm-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/cassm-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Embrace a new era of dynamic learning &amp; flexibility in social science and management education.</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
                                ...
                                <li>
                                    <a href="/physical-education/">University Institute of Physical Education and Sports</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/pes-institute-bg.jpg');" data-src="<?=@$imgPath?>header-footer/pes-institute-bg.jpg"></div>                                            
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazybg" style="background: url('<?=@$imgPath?>header-footer/pes-institute-bg-small.jpg');" data-src="<?=@$imgPath?>header-footer/pes-institute-bg-small.jpg"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                                    <h5 class="text-white">Lead the way in physical education with emphasis on fundamental principles, psychological aspects, and leadership development</h5>
                                                    <div class="btn-grp">
                                                      <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" class="btn btn-primary" target="_blank">Apply Today</a> 
                                                    </div>                                                
                                                </div>                                                
