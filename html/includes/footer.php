            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 col-md-5 social-media-icons ms-auto">
                    <ul class="m-0 list-unstyled d-flex justify-content-between">
                        ...
                        <li><a href="https://twitter.com/Chandigarh_uni" rel="nofollow" target="_blank" aria-label="Go to Chandigarh University's Twitter (X) Page"><img src="https://www.cuchd.in/includes/assets/images/header-footer/twitter-icon.webp" alt="" height="12" class="f-twitter-icon"></a></li>
                        ...
                        <li><a href="https://www.threads.net/@chandigarhuniversity" target="_blank" aria-label="Go to Chandigarh University's Threads Page"><img src="https://www.cuchd.in/includes/assets/images/header-footer/threads-icon.webp" alt="" height="14"></a></li>
                        <li><a href="https://www.snapchat.com/add/chd_university" target="_blank" aria-label="Go to Chandigarh University's Threads Page"><i class="fa-brands fa-snapchat"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-4">
                    ...
                    <div class="card br-6 bdr-1 h-100 bg-transparent me-2 w-50">
                        <div class="card-body text-center align-items-center d-flex">
                            <a href="https://www.cuchd.in/radio-punjab-90/" target="_blank" class="w-100">
                                <img class="lazyload_" src="https://www.cuchd.in/includes/assets/images/header-footer/radio-punjab-logo.webp" alt="Radio Punjab 90.0" title="Radio Punjab 90.0" width="110">
                            </a>
                        </div>
                    </div>
                    <div class="card br-6 bdr-1 h-100 bg-transparent w-50">
                        <div class="card-body text-center align-items-center d-flex">
                            <a href="https://www.cuchd.in/maps/" class="w-100">
                                <img class="lazyload_" src="https://www.cuchd.in/includes/assets/images/header-footer/virtual-tour-logo-w.webp" alt="Virtual Tour 360" title="Virtual Tour 360" width="110">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-4 position-relative">
                    <div class="unai-logo">
                        <img class="img-fluid lazyload_" src="https://www.cuchd.in/includes/assets/images/header-footer/unai-logo.webp" alt="UNAI">
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="modal-content bg-transparent border-0">
      ...
      <div class="modal-body pt-2 text-center uniSearch">
          <form class="position-relative" action="https://www.cuchd.in/searchresult.php" method="get" role="search">
            ...
            <input type="submit" value="" class="se-btn ptrans" style="background-image: url(https://www.cuchd.in/includes/assets/images/search-icon.webp);">
          </form>       
      </div>
    </div>
  </div>
