...
$waltDisney = '370+';
$researchCenter = '60';
$isInnerPage = basename($_SERVER['SCRIPT_NAME']) !== 'index.php';
?>


<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
    integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
<link rel="stylesheet" href="https://www.cuchd.in/latest-assets/css/tiny-slider.min.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.1/css/all.min.css">
<link href="https://www.cuchd.in/latest-assets/css/header-footer.min.css?v=1.0" rel="stylesheet">
...
<style>
    header a {
        ...
        .header .menu-options li.event-highlight a, .header.sticky .menu-options li.event-highlight a {
...
.xs-btn {
	...
	color: var(--bg-darkyellow) !important;
    position: relative;
    margin-left: 40px;
    padding-left: 38px;
    padding-right: 38px;
    ...
    <div class="header__main">
            ...
            <div class="headerTopSocial d-flex align-items-center">
                ...
                <ul class="header__top-right social-sub w-auto d-flex list-unstyled p-0 m-0 align-items-center">
                    ...
                    <li><a rel="nofollow" href="https://www.snapchat.com/add/chd_university" target="_blank"
                            aria-label="Go to Chandigarh University's Snapchat"></a></li>                    
                </ul>
                <ul class="header__top-right w-auto d-flex list-unstyled p-0 m-0 align-items-center desksearch">
                    <li class="head-search m-0">
                        <button id="search-page-mob" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            aria-label="Search Chandigarh University Website" class="text-white m-0">
                            <img src="../includes/assets/images/header-footer/search-icon-small.png" alt="Search icon">
                            <span>Search</span>
                        </button>
                    </li>
                </ul>                 
        ...
        <div class="navbar-brand p-0 mt-0">
            <div class="d-flex align-items-center">
                <a href="https://www.cuchd.in/" aria-label="Go to Chandigarh University's Home Page">
                    <img src="https://www.cuchd.in/includes/assets/images/header-footer/cu-logo-white.webp" alt="" width="221" class="me-2 cu-logo">
                </a>
            </div>
            <div class="d-flex ms-auto showOnMobile">
                <div class="d-flex header_btn blue-gradient me-3">
                    <a href="tel:+1800121288800" class="d-flex align-items-center text-white"
                        ...
                        <img src="https://www.cuchd.in/includes/assets/images/header-footer/phone-icon.webp" alt="" width="30">
                        <span class="d-block ms-2">
                            <small class="d-block text-capitalize">Admission Helpline</small>1800121288800
                        </span>
                    </a>
                </div>            
                <ul class="header__top-right w-auto d-flex list-unstyled p-0 m-0 align-items-center tabletsearch">
                    <li class="head-search m-0">
                        <button id="search-page-mob" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            aria-label="Search Chandigarh University Website" class="text-white m-0"><i
                                class="fa fa-search" aria-hidden="true"></i><span>Search</span></button>
                    </li>
                </ul>
        ...
        <nav class="navbar navbar-expand-xl">
            ...
            <div class="mobileNavHeader d-none">
                <a href="https://www.cuchd.in/" aria-label="Go to Chandigarh University's Home Page">
                    <img src="https://www.cuchd.in/includes/assets/images/header-footer/cu-logo-dark.webp" alt="" width="180" class="me-2 cu-logo">
                </a>
            ...
            <div class="container-fluid align-items-start">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="upper-header">
                        <ul class="menu-options list-unstyled m-0 p-0 m-auto">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-6">
                                            <a href="https://www.cuchd.in/">
                                                <img src="https://www.cuchd.in/includes/assets/images/header-footer/cuchd-icon.webp" alt=""
                                        ...
                                        <div class="col-6">
                                            <a rel="" href="https://www.culko.in/" target="_blank">
                                                <img src="https://www.cuchd.in/includes/assets/images/header-footer/culko-icon.webp" alt=""
                                                    class="w-100" width="70">
                    ...
                    <div class="lower-header">
                        <ul class="navbar-nav me-auto step-first-menu d-flex justify-content-around">
                            <li class="nav-item dd-menu-lg">
                                <a href="https://www.cuchd.in/about/" class="mob-void">About</a>
                                <div class="step-second-menu st-about">
                                    <div class="row g-0 h-100">
                                        ...
                                        <div class="col-md-4 about-graphic d-none d-lg-block lazy-bg"
                                            style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/lazy-about-dd-image.webp'); margin: -20px -20px -20px 20px;  background-size: cover;"
                                            data-bg="https://www.cuchd.in/includes/assets/images/header-footer/about-dd-image.webp">
                            ...
                            <li class="nav-item dd-menu-lg">
                                ...
                                <div class="step-second-menu st-programs">
                                    <div class="row h-100 g-0">
                                                        ...
                                                        <div class="col-xl-6">
                                                            <ul class="list-unstyled p-0 m-0">
                                                                ...
                                                                <li><a href="https://www.cuchd.in/basic-sciences/">Physics<small
                                                                            style="font-size:11px;"> (B.Sc./ M.Sc.)</small></a>
                                                                </li>
                                                            ...
                                                            <ul class="list-unstyled p-0 m-0">
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        Data Science with <img
                                                                            data-src="https://www.cuchd.in/includes/assets/images/header-footer/intel-logo.svg"
                                                                ...
                                                                <li><a href="https://www.cuchd.in/IBM/">CSE with <img
                                                                            data-src="https://www.cuchd.in/includes/assets/images/header-footer/IBM-logo.webp"
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        CSE Artificial<br> Intelligence with <img
                                                                            data-src="https://www.cuchd.in/includes/assets/images/header-footer/microsoft-logo.png"
                                                                            alt="BE CSE AI with Microsoft"
                                                                            style="vertical-align: baseline; margin-left: 2px;"
                                                                            width="60px" class="ptrans lazy-img"></a>
                                                                </li>
                                                                <li><a
                                                                        href="https://www.cuchd.in/engineering/virtusa-me-cse-cloud-computing.php">ME
                                                                        CSE Cloud<br> Computing with <img
                                                                            data-src="https://www.cuchd.in/includes/assets/images/header-footer/virtusa-logo.webp"
                                                                            alt="ME CSE with Virtusa"
                                                                            style="margin-top: -4px;" width="50px"
                                                                            class="ptrans lazy-img"></a>
                                                                </li>
                                                                <li><a href="https://www.cuchd.in/TCS/">CSE with <img
                                                                            data-src="https://www.cuchd.in/includes/assets/images/header-footer/TCS-logo.webp"
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        Thronton <img
                                                                            data-src="https://www.cuchd.in/includes/assets/images/header-footer/acca-header-logo.webp"
                                                                ...
                                                                <li><a
                                                                        ...
                                                                        Healthcare and Hospital Management <img
                                                                            data-src="https://www.cuchd.in/includes/assets/images/header-footer/max-logo.jpg"
                                                                            alt="MBA
                                                    ...
                                                    <ul class="list-unstyled p-0 m-0">
                                                        <li><a
                                                                ...
                                                                in Capital Markets with <img
                                                                    data-src="https://www.cuchd.in/includes/assets/images/header-footer/nism-logo.webp"
                                                        ...
                                                        <li><a
                                                                ...
                                                                Strategic HR with <img
                                                                    data-src="https://www.cuchd.in/includes/assets/images/header-footer/aon-logo.webp"
                                                        ...
                                                        <li><a
                                                                ...
                                                                Data Science & AI with <img
                                                                    data-src="https://www.cuchd.in/includes/assets/images/header-footer/sas-logo.webp"
                                                        ...
                                                        <li><a
                                                                ...
                                                                in Applied Finance & Analytics with <img
                                                                    data-src="https://www.cuchd.in/includes/assets/images/header-footer/pwc-logo-new.png"
                                                        ...
                                                        <li><a href="https://www.cuchd.in/apex-management/bfe.php">MBA
                                                                in Banking, Financial Services & Insurance <img
                                                                    data-src="https://www.cuchd.in/includes/assets/images/header-footer/SBI-logo.webp"
                                                        ...
                                                        <li><a
                                                                ...
                                                                Digital
                                                                Marketing<!--<img
                                                                        data-src="https://www.cuchd.in/includes/assets/images/header-footer/adobe-logo.png"
                                                        ...
                                                        <li><a
                                                                ...
                                                                FinTech & AI <img
                                                                    data-src="https://www.cuchd.in/includes/assets/images/header-footer/nse-acadmey.webp"
                                                                    alt="MBA with Fintech" style="margin-top: -2px;"
                                                                    width="36px" class="ptrans lazy-img"></a>
                                                        </li>
                                                        <li><a
                                                                href="https://www.cuchd.in/apex-management/MBA-logistics-and-supply-chain-management.php">MBA
                                                                Logistics and Supply Chain Management
                                                                with
                                                                <img data-src="https://www.cuchd.in/includes/assets/images/header-footer/cii-logo.webp"
                                        ...
                                        <div class="col-xl-2 col-lg-12 pg-bg program-graphic d-none d-lg-block lazy-bg"
                                            style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/lazy-program-dd-image.webp'); margin: -20px -20px -20px 20px; background-size: cover;"
                                            data-bg="https://www.cuchd.in/includes/assets/images/header-footer/program-dd-image.webp">
                                                ...
                                                <div class="placement--ddNumbers progNos mt-3">
                                                    <div class="row g-2">
                                                        <div class="col-4 col-xl-12">
                                                            ...
                                                            <p id="pyr">Offered in <span class="d-none"></span><?= @$year ?></p>
                                                        </div>
                                                        <div class="col-4 col-xl-12">
                                                            <div class="card p-2">
                                                                <span>
                            ...
                            <li class="nav-item dd-menu-lg">
                                <a href="https://www.cuchd.in/academics/" class="mob-void">Academics</a>
                                <div class="step-second-menu st-academics">
                                    <div class="row g-0 h-100">
                                        <div class="col-lg-5">
                                            <h4 class="d-none d-xl-block">Academics</h4>
                                            <ul class="list-unstyled p-0 m-0">
                                        ...
                                        <div class="col-lg-7 d-none d-xl-block lazy-bg"
                                            ...
                                            <div class="drop-down-graphic position-relative h-100">
                                                ...
                                                <div class="dd-graphic-cont mt-4">
                                                    <div class="row g-0">
                                                        <div class="col-6 p-2 py-3 d-flex">
                                                            <div class="dd--title align-self-center mx-auto">
                                                                <span>
                            ...
                            <li class="nav-item dd-menu-lg">
                                <a href="https://www.cuchd.in/admissions/" class="mob-void">admissions</a>
                                <div class="step-second-menu st-admissions">
                                    ...
                                    <div class="d-none d-xl-block" style="margin: 65px -20px 0 -20px;">
                                        <div class="redbox-applynow position-relative seagreen-overlay-faded lazy-bg"
                                            style="background-image: url(https://www.cuchd.in/includes/assets/images/header-footer/lazy-unique3-bg.webp);"
                                            data-bg="https://www.cuchd.in/includes/assets/images/header-footer/unique3-bg.webp">
                            ...
                            <li class="nav-item dd-menu-lg">
                                <a href="https://www.cuchd.in/campus-life/" class="mob-void">campus life</a>
                                <div class="step-second-menu st-campus">
                                    <div class="d-none d-xl-block" style="margin: -20px -20px 15px -20px;">
                                        <div class="redbox-applynow position-relative seagreen-overlay-faded lazy-bg"
                                            style="background-image: url(https://www.cuchd.in/includes/assets/images/header-footer/lazy-campus-bg.webp);"
                                            data-bg="https://www.cuchd.in/includes/assets/images/header-footer/campus-bg.webp">
                                            <div class="position-relative">
                            ...
                            <li class="nav-item dd-menu-lg">
                                <a href="https://www.cuchd.in/placements/" class="mob-void">placements</a>
                                <div class="step-second-menu st-placements">
                                    <div class="row g-0 h-100">
                                        <div class="col-lg-6 d-none d-xl-block lazy-bg"
                                            style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/lazy-placement-bg.webp'); margin: -20px 20px -20px -20px;  background-size: cover;"
                                            data-bg="https://www.cuchd.in/includes/assets/images/header-footer/placement-bg.webp">
                                            <div class="drop-down-graphic position-relative h-100">
                                                            ...
                                                            <div class="dd--title align-self-center mx-auto">
                                                                <span>
                                                                    <img class="w-100 lazy-img"
                                                                        data-src="https://www.cuchd.in/includes/assets/images/header-footer/mahindra-logo-dark.webp">
                                                                </span>
                                                                Mahindra
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <h4 class="d-none d-xl-block">Placements</h4>
                                            <ul class="list-unstyled p-0 m-0">
                            ...
                            <li class="nav-item dd-menu-lg">
                                <a href="https://www.cuchd.in/research/" class="mob-void">Research &amp; Innovation</a>
                                <div class="step-second-menu st-research">
                                    <div class="row g-0 h-100">
                                        <div class="col-lg-6 d-none d-xl-block lazy-bg"
                                            style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/lazy-research-bg.webp'); margin: -20px 20px -20px -20px; background-size: cover;"
                                            data-bg="https://www.cuchd.in/includes/assets/images/header-footer/research-bg.webp">
                                            <div
                                                class="program-drop-down-graphic position-relative h-100 text-center d-flex flex-column justify-content-between">
                                                <h3>Our<span> Intellectual </span>Pursuits</h3>
                                                <div class="placement--ddNumbers mt-4">
                                                    <div class="row g-3">
                                                        <div class="col-6">
                                                            <div class="card h-100 p-3">
                                                                <span>
                                                                    <h4 id="research-pub"><span
                                                                            class="d-none"></span><?= @$publishedJournals ?></h4>
                        ...
                        <div class="d-flex hideOnMobile">
                            <div class="d-flex header_btn blue-gradient">
                                <a href="tel:+1800121288800" class="d-flex align-items-center text-white"
                                    aria-label="Call CU's Admission Helpline">
                                    <span class="d-block"> <!-- removed 'ms-2' -->
                                        <small class="d-block text-capitalize">Admission Helpline (Free)</small>1800121288800
                                    </span>
                                </a>
                            </div>
                            
<a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&amp;utm_medium=engineering" class="btn btn-primary btn-hoverEffect apnowbtn" target="_blank">Apply Now <img alt="Button Arrow" width="13" class="ms-2" src="../includes/assets/images/header-footer/right-arrow-small.png"></a>  
                    ...
                    <div class="col-xl-7">
                        ...
                        <div class="institute-list">
                            <ul class="list-unstyled step-first-menu hover-header-list ps-0">
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/engg-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/engg-institute-bg-small.webp">
                                            </div>
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/management-institute-bg.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/management-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/computing-institute-bg.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/computing-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/pharma-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/pharma-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/bio-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/bio-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/arch-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/arch-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/liberal-institute-bg.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/liberal-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/uifva-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/uifva-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/uittr-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/uittr-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/legal-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/legal-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/media-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/media-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/uis-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/uis-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    <a href="https://www.cuchd.in/applied-health-sciences/">University Institute of Applied Health
                                        Sciences</a>
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/ahs-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/ahs-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/design-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/design-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/uithm-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/uithm-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/gsfa-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/gsfa-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/cassm-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/cassm-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
                                ...
                                <li>
                                    ...
                                    <div class="step-second-menu institute-info-sec bg-transparent p-0">
                                        <div class="row g-0 h-100">
                                            <div class="col-lg-12 h-55 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-big.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/pes-institute-bg.webp"></div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block lazy-bg"
                                                style="background: url('https://www.cuchd.in/includes/assets/images/header-footer/institute-bg-small.webp');"
                                                data-bg="https://www.cuchd.in/includes/assets/images/header-footer/pes-institute-bg-small.webp">
                                            </div>
                                            <div class="col-lg-6 h-45 d-none d-lg-block">
                                                <div
                                                    class="institute-content d-flex flex-column  justify-content-between h-100 p-5">
