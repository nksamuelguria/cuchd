    ...
    <link href="<?= @$rootPath ?>latest-assets/css/main-landing-2025.css?v=1.55" rel="stylesheet">
    ...
    <link rel="icon" type="image/png" sizes="192x192"
        href="https://www.cuchd.in/add_to_homescreen/android-icon-192x192.png">
    ...
    <style>
            /* FAQ 2026 styling */
            .faqSection__content .subHeading span {
                color: #fa0d0d;
            }
            ...
            .helpLines h4 {
                ...
                font-weight: normal;
                color: #666666;
                border-bottom: 1px solid #fa0d0d;
                padding: 0 0 20px;
                margin-bottom: 30px;
            }
            ...
            .faqSection__content .accordion-body {
                padding: 0 45px 20px 45px;
                border-top: 0 !important;
            }

            .faqSection__content .accordion-button {
                font-size: 20px;
                color: #333;
                font-weight: bold;
            ...
            .faqSection__content .accordion-button::after {
                content: "";
                background-image: url('https://www.cuchd.in/latest-assets/img/fc-plus-icon.png');
                left: 0;
                position: absolute;
                top: 18px;
            }

            .faqSection__content .accordion-button:not(.collapsed)::after {
                content: "";
                background-image: url('https://www.cuchd.in/latest-assets/img/fc-minus-icon.png');
            }

            .faqSection__content .accordion-item {
                border-radius: 0 !important;
                border: 0;
            ...
            @media only screen and (max-width: 575px) {
                ...
                .faqSection__content .accordion-body p {
                    font-size: 14px;
                    line-height: 18px;
                    margin: 0;
                }
            ...
            /* Curriculum 2026 styling */

            .curriculum-strip {
                padding: 25px 15px;
                background: linear-gradient(90deg, #f8f9fb, #f1f3f6);
                border-radius: 10px;
                display: flex;
            ...
            .curriculum-strip .cta-link::after {
                content: "";
                position: absolute;
                left: 0;
                bottom: -3px;
            ...
            .curriculum-strip:hover {
                background: #fff;
                box-shadow: 0 8px 20px rgba(0, 0, 0, 0.05);
            }

            .curriculum-strip:hover .cta-link::after {
                width: 100%;
            }
...
gtag('config', 'G-8N1BKMH5LY');
    ...
    <noscript>
        <iframe src="//www.googletagmanager.com/ns.html?id=GTM-WGZBMSV" height="0" width="0"
