                                            ...
                                            <div class="placement--ddNumbers progNos mt-3">
                                                <div class="row g-2">
                                                    <div class="col-4 col-xl-12">
                                                        ...
                                                        <p>Offered in <?=@$year?><!--<br>(Highest in India)--></p>
                                                    </div>
                                                    <div class="col-4 col-xl-12">
                                                        <div class="card p-2">
                                                            <span>
                        ...
                        <li class="nav-item dd-menu-lg">
                            ...
                            <div class="step-second-menu st-admissions">
                                ...
                                <div class="d-none d-lg-block" style="margin: 0 -20px 0 -20px;">
                                    <div class="redbox-applynow position-relative blue-overlay lazybg" style="background-image: url(<?=@$imgPath?>header-footer/lazy-unique3-bg.webp);" data-src="<?=@$imgPath?>header-footer/unique3-bg.webp">
