                ...
                <div class="col-12 col-lg-3 col-md-5 social-media-icons ms-auto">
                    <ul class="m-0 list-unstyled d-flex justify-content-between">
                        ...
                        <li><a href="https://www.threads.net/@chandigarhuniversity" target="_blank" aria-label="Go to Chandigarh University's Threads Page"><img src="../includes/assets/images/header-footer/threads-icon.webp" alt="" height="14"></a></li>
                         <li><a href="https://www.snapchat.com/add/chd_university" target="_blank" aria-label="Go to Chandigarh University's Snapchat Page"><i class="fa-brands fa-snapchat"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script src="https://www.cuchd.in/new-assets/js/jquery-3.7.1.min.js"></script>
<script src="https://www.cuchd.in/latest-assets/js/bootstrap.bundle.min.js" defer></script>
<script>
    setTimeout(function() {
...
$(document).ready(function () {
        $("#plac-no span").replaceWith('10000+');
        $("#high-pk span").replaceWith('1.7');
        $("#high-npk span").replaceWith('54.75');
        $("#patent-no span").replaceWith('5300+');
        $("#research-pub span").replaceWith('21000+');
        $("#pyr span").replaceWith('Batch 2024-25');
    });
</script>    
-->
...
.sbt-widget-close svg,.sbt-widget-minimize svg{fill:#000!important}
.sbt-widget-title{font-weight:400!important}
.sbt-powered-by{display:none!important}
@media (max-width:575px){
  .sbt-widget-trigger-container{right:3px!important;bottom:34px!important}
}
`;

function applySuperbotStyles() {
  const host = document.getElementById("sbt-widget-host");
  const style = host?.shadowRoot?.getElementById("sbt-minimize-styles");

  if (!style) return false;

  if (!style.textContent.includes(".sbt-widget-trigger-container{")) {
