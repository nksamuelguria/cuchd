  ...
  <div className="header__main">
    <div className="headerTopBar d-flex align-items-center justify-content-between">
      ...
      <div className="headerTopSocial d-flex align-items-center">
        ...
        <ul className="header__top-right social-sub w-auto d-flex list-unstyled p-0 m-0 align-items-center">
    ...
    <div className="navbar-brand p-0 mt-0">
      ...
      <div className="d-flex ms-auto showOnMobile">
        ...
        <ul className="header__top-right w-auto d-flex list-unstyled p-0 m-0 align-items-center tabletsearch">
          <li className="head-search m-0">
      ...
      <div className="container-fluid align-items-start">
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          <div className="upper-header">
            <ul className="menu-options list-unstyled m-0 p-0 m-auto"> {/* removed 'position-relative' class and brought lower-head below this */}
              {/*<li class="event-highlight"><a href="https://www.cuchd.in/aifest-2026/" target="_blank">AI FEST 2026</a></li>*/}
              <li className="position-relative campusDdLink">
                <a href="#">Campuses</a>
            ...
            <div className="lower-header">
              <ul className="navbar-nav me-auto step-first-menu d-flex justify-content-around">
                    ...
                    <div className="row h-100 g-0">
                      <div className="col-xl-10 col-lg-12">
                        ...
                        <div className="row g-3">
                          ...
                          <div className="col-md-12 d-block d-lg-none mt-3">
                            <div className="row g-3">
                              <div className="col-lg-6">
                                <div className="card br-6 p-3">
                                  <a rel="nofollow" href="https://www.cuidol.in/?utm_source=Website&utm_medium=cuchd" target="_blank" className="position-relative text-dark text-uppercase"><small>Click
                              ...
                              <div className="col-lg-6">
                                <div className="card br-6 p-3">
                                  <a rel="nofollow" href="https://www.onlinecu.in/?utm_source=Website&utm_medium=cuchd" target="_blank" className="position-relative text-dark text-uppercase"><small>Click
                                      here to view Programs
                            ...
                            <div className="row g-2">
                              <div className="col-4 col-xl-12">
                                <div className="card p-2">
                                  <span>
                                    <h4 id="plac-no"><span className="d-none" />
                                    </h4>
                              ...
                              <div className="col-4 col-xl-12">
                                <div className="card p-2">
                                  <span>
                                    <h4 id="high-pk"><span className="d-none" />
                                      <sub>CR
                                      </sub>
                                    </h4>
                              ...
                              <div className="col-4 col-xl-12">
                                <div className="card p-2">
                                  <span>
                                    <h4 id="high-npk"><span className="d-none" />
                                      <sub>LPA</sub>
                                    </h4>
                  ...
                  <div className="step-second-menu st-academics">
                    <div className="row g-0 h-100">
                      <div className="col-lg-5">
                        <h4 className="d-none d-xl-block">Academics</h4>
                        <ul className="list-unstyled p-0 m-0">
                    ...
                    <div className="d-none d-xl-block" style={{margin: '65px -20px 0 -20px'}}>
                      <div className="redbox-applynow position-relative seagreen-overlay-faded lazy-bg" style={{backgroundImage: 'url(header-footer/lazy-unique3-bg.webp)'}} data-bg="header-footer/unique3-bg.webp">
                        <div className="position-relative">
                          ...
                          <div className="row g-0">
                            <div className="col-4 p-2 py-3 d-flex">
                              <div className="dd--title align-self-center mx-auto">
                                <span>
                    ...
                    <div className="d-none d-xl-block" style={{margin: '-20px -20px 15px -20px'}}>
                      <div className="redbox-applynow position-relative seagreen-overlay-faded lazy-bg" style={{backgroundImage: 'url(header-footer/lazy-campus-bg.webp)'}} data-bg="header-footer/campus-bg.webp">
                        <div className="position-relative">
                          ...
                          <div className="row g-0">
                            <div className="col-3 p-2 py-3 d-flex">
                              <div className="dd--title align-self-center mx-auto">
                                <span>
                                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 480" width={44}>
                                    <path className="stval" d="M441.9 280.3c-1.1-0.3-2.2-0.3-3.4-0.1l-78.6 14.3v-38.4c0-4.4-3.6-8-8-8h-48c-2.1 0-4.2 0.8-5.7 2.3l-29.7 29.7h-49.4l-29.7-29.7c-1.5-1.5-3.5-2.3-5.7-2.3h-48c-4.4 0-8 3.6-8 8v38.1l-75.5-16.5c-3-0.9-6-1.5-9.1-2 -4.4-0.6-8.4 2.4-9.1 6.7 -0.6 4.2 2.1 8.1 6.2 9l8 1.8c9.8 3 18.4 9.1 24.6 17.3 2.3 3.1 4.2 6.5 5.7 10l-29.3-5.9c-2.3-1-4.8-1.7-7.3-2.1 -20.2-2.9-38.9 11.1-41.8 31.3 0 0 0 0 0 0.1 -3.4 24.2 13.4 46.5 37.5 50 2.5 0.4 5 0.5 7.6 0.5 1.1 0 2.1-0.2 3.2-0.3v0.3l87-8 -37.6 40.3c-3 3.2-2.8 8.3 0.4 11.3 1.5 1.4 3.5 2.2 5.5 2.2h24v24c0 4.4 3.6 8 8 8 2.1 0 4.2-0.8 5.7-2.3l77.7-77.7h49.4l77.7 77.7c1.5 1.5 3.5 2.3 5.7 2.3 1.1 0 2.1-0.2 3.1-0.6 3-1.2 4.9-4.2 4.9-7.4v-24h24c4.4 0 8-3.6 8-8 0-2-0.8-4-2.2-5.5l-38.1-40.8 87.7 6.3c0.2 0 0.4 0 0.6 0 0.7 0 1.3-0.1 1.9-0.2 13.2-3.3 38.1-19.2 38.1-55.8S455.1 283.5 441.9 280.3zM35.2 346.6L35.2 346.6c0.3-1.9 1.9-3.3 3.8-3.3 0.2 0 0.4 0 0.5 0l2.1-14.8c7.5 2 12.3 9.2 11.2 16.9 -0.8 5.8-6.1 9.8-11.9 8.9C37.2 353.8 34.6 350.4 35.2 346.6zM82.4 346.3c-2.9 20.4-21.8 34.5-42.1 31.6h0c-15.4-2.2-26.1-16.5-23.9-31.9 1.2-8.3 7.2-15 15.2-17.3 -6.5 2.7-11.2 8.6-12.2 15.6 -1.8 12.5 6.9 24 19.4 25.8 14.5 2.1 27.9-8 30-22.5 0 0 0 0 0 0 0.6-4.4 0.3-9-1-13.3l15.1 3C82.9 340.4 82.8 343.4 82.4 346.3zM86.7 374.7c6.1-7.5 10.1-16.5 11.5-26.1 2.4-16.7-1.9-33.7-11.9-47.3l41.7 9.1v33.6c0 4.4 3.6 8 8 8h31.7l-15.6 16.7L86.7 374.7zM208 380.7l-64 64v-12.7c0-4.4-3.6-8-8-8h-13.6l37.3-39.9 1.1-0.1 -0.1-0.9 47.4-50.8V380.7zM208 308.7l-27.3 27.3h-36.7v-72h36.7l27.3 27.3V308.7zM264 312v64h-40v-80h40V312zM280 291.3l27.3-27.3h36.7v72h-36.7l-27.3-27.3V291.3zM365.6 424h-13.6c-4.4 0-8 3.6-8 8v12.7l-64-64v-48.4l47.5 50.9 -0.1 0.8 0.9 0.1L365.6 424zM439.1 375.9l-103.4-7.4 -15.4-16.5H352c4.4 0 8-3.6 8-8v-33.3l79.5-14.4c5.4 2 24.5 11 24.5 39.8C464 365.5 444 374.2 439.1 375.9z" />
                ...
                <li className="nav-item dd-menu-lg">
                  ...
                  <div className="step-second-menu st-placements">
                    <div className="row g-0 h-100">
                      ...
                      <div className="col-lg-6">
                        <h4 className="d-none d-xl-block">Placements</h4>
                        <ul className="list-unstyled p-0 m-0">
                          ...
                          <div className="placement--ddNumbers mt-4">
                            <div className="row g-3">
                              ...
                              <div className="col-6">
                                <div className="card h-100 p-3">
                                  <span>
                                    <h4 id="patent-no"><span className="d-none" /></h4>
            ...
            <div className="d-flex hideOnMobile">
              <div className="d-flex header_btn blue-gradient">
                <a href="tel:+1800121288800" className="d-flex align-items-center text-white" aria-label="Call CU's Admission Helpline">
                  <span className="d-block"> {/* removed 'ms-2' */}
                    <small className="d-block text-capitalize">Admission Helpline (Free)</small>1800121288800
                  </span>
                </a>
              </div>
        ...
        <div className="row g-0">
          <div className="col-xl-7">
            ...
            <div className="institute-list">
              <ul className="list-unstyled step-first-menu hover-header-list ps-0">
                <li className="active">
                      ...
                      <div className="col-lg-6 h-45 d-none d-lg-block">
                        <div className="institute-content d-flex flex-column justify-content-between h-100 p-4 p-xxl-5">
                          ...
                          <div className="btn-grp">
                            <a href="https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd" className="btn btn-primary" target="_blank">Apply Today</a>
                          </div>
                        </div>
                      </div>
                    </div>
